...
proc init_board {} {
	...
	#
	# Ardmore: disable watchdog by driving GPIO11 (TPM_RST_L) low
	#
	mem [CCSR 0xf000] = 0x100000
	mem [CCSR 0xf008] = 0x0
...
proc P1020RDB_init_core {} {
	...
	# define 64MB   TLB1 entry 8: 0xFC000000 - 0xFFFFFFFF; for Local Bus, cache inhibited, guarded
	reg ${CAM_GROUP}L2MMU_CAM8 = 0x80000FCAFC080000FC000000FC000001
