...
#if defined(CONFIG_APBOOT) && defined(powerpc)
extern int arch_memory_test_prepare(u32 *vstart, u32 *size, phys_addr_t *phys_offset);
extern int arch_memory_test_advance(u32 *vstart, u32 *size, phys_addr_t *phys_offset);
extern int arch_memory_test_cleanup(u32 *vstart, u32 *size, phys_addr_t *phys_offset);
extern void arch_memory_failure_handle(void);
#else
__attribute__((weak))
