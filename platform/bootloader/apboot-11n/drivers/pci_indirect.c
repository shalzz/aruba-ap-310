...
#if defined(CONFIG_OCTEON) || defined(AR7100)
extern unsigned char    in_8 (volatile unsigned char *addr);
extern unsigned short   in_le16 (volatile unsigned short *addr);
extern unsigned         in_le32 (volatile unsigned *addr);
extern void             out_8 (volatile unsigned char *addr, char val);
extern void             out_le16 (volatile unsigned short *addr, unsigned short val);
