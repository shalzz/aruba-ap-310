...
extern void iproc_watchdog_check(void);
#endif
...
void board_init_f(ulong bootflag)
{
    ...
    /* barrier to make sure dram init happened before following instruction */
    CP15ISB;
    CP15DSB;
    CP15DMB;
    asm volatile("nop");
...
//#if !defined(CONFIG_OCTOMORE) /* FIXME_OCTOMORE: temporarily turned off */
	post_bootmode_init();
