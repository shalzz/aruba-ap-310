...
#if 0
/*
 * SCA; XXX; this is not working right and this is preempting the one in
...
#else
extern void board_add_ram_info(int);
#endif
...
//	post_run (NULL, POST_RAM | post_bootmode_get(0));
	post_run (NULL, POST_RAM | POST_ALWAYS);
#endif
