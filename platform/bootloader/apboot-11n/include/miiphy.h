...
#if defined(CFG_FAULT_ECHO_LINK_DOWN) || defined(CONFIG_AR7100) || \
    defined(CONFIG_AR7240) || defined(CONFIG_IPROC) || \
    defined(CONFIG_OCTOMORE) || defined(CONFIG_EIGER) || \
    defined(CONFIG_GLENFARCAS)
