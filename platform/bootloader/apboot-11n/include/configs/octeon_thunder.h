...
/* CONFIG_OCTEON_THUNDER set by Makefile in include/config.h */ 
...
/* use configuration eeprom tuple format*/
...
#define OCTEON_PAL_BASE_ADDR        0

/* EEPROM addresses on THUNDER board */
#define BOARD_EEPROM_TWSI_ADDR        OCTEON_THUNDER_EEPROM_ADDR
...
/* Enable the setbypass command for controlling the LAN bypass relays */
#define CONFIG_OCTEON_LANBYPASS 1
...
#ifdef CONFIG_OCTEON_FAILSAFE
#define	CFG_PROMPT		"Octeon thunder Failsafe bootloader# "	/* Monitor Command Prompt    */
#else
#if CONFIG_RAM_RESIDENT
#define	CFG_PROMPT		"Octeon thunder(ram)# "	/* Monitor Command Prompt    */
#else
#define	CFG_PROMPT		"Octeon thunder# "	/* Monitor Command Prompt    */
#endif
#endif
...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
	"bootloader_flash_update=protect off 0xbf440000 0xbf47ffff;erase 0xbf440000 0xbf47ffff;cp.b 0x100000 0xbf440000 0x40000\0"				\
 ...
 */
#define CFG_FLASH_SIZE          (8*1024*1024)
...
#define DDR_BOARD_DELAY		OCTEON_THUNDER_DDR_BOARD_DELAY   /* First guess was 3815 */
