...
#define ARUBA_BOARD_TYPE                "Sierra"
...
#ifndef __ASSEMBLY__
#include <compiler.h>
#include "../../board/qca/sierra/ipq806x_cdp.h"
...
#define GPIO_PCIE_1_RST_L 48 /* Active low to reset PCIE 1 */
#define GPIO_PCIE_2_RST_L 3 /* Active low to reset PCIE 2 */
...
#define GPIO_TCA9539_RESET 65	/*active high to reset TCA9539*/

/* GPIO inputs */
#define GPIO_POWER_AT 23
#define GPIO_POWER_DC 16
