...
// removed these to support reset on gpio pin 0: | CFG_CMD_DTT | CFG_CMD_DATE | CFG_CMD_I2C
#define CONFIG_COMMANDS (( CONFIG_CMD_DFL        | CFG_CMD_MII   | CFG_CMD_PING  \
   | CFG_CMD_NET | CFG_CMD_PCI     | CFG_CMD_ENV | CFG_CMD_FLASH  \
   | CFG_CMD_DTT | CFG_CMD_DATE | CFG_CMD_I2C \
...
#define ARUBA_BOARD_TYPE	"Talisker"
