...
/* used for early shutdown of PSE and jtag-disable */
#define CONFIG_PSE_SHUTDOWN 1
#define CONFIG_JTAG_DISABLE 1

/* DDR settings for WASP */
#define CONFIG_REV_J_DDR2 1
...
#else
/* revI */
#define CFG_934X_DDR2_CONFIG_VAL         0xc7bc8cd0
#define CFG_934X_DDR2_CONFIG2_VAL        0x9dd0e6a8
#define CFG_934X_DDR2_MODE_VAL_INIT      0x133
#define CFG_934X_DDR2_MODE_VAL           0x33
#define CFG_934X_DDR2_EXT_MODE_VAL_INIT  0x380
#define CFG_934X_DDR2_EXT_MODE_VAL       0x0
#define CFG_934X_DDR2_EN_TWL_VAL         0xe59
...
#define __TLV_INVENTORY_BUF_SIZE__	(16 * 1024)
/* for Cardhu, the variant is on the base board */
#define __CARD_WITH_VARIANT__   1

#define __MODEL_STR__ "RAP-3x"
