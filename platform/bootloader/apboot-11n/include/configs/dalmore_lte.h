...
#define ARUBA_BOARD_TYPE    "Dalmore-LTE"
...
#define GPIO_LTE_GREEN_LED     2
#define GPIO_LTE_AMBER_LED     3
...
#define __MODEL_STR__ "RAP-108L/RAP-109L"
