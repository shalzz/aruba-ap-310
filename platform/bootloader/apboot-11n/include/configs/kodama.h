...
/* CONFIG_OCTEON_KODAMA set by Makefile in include/config.h */
...
/* bootloader usable memory size in bytes for Kodama, hard code until autodetect */
...
**	0x1b010000 - 0x1b01ffff CF attribute mapping
**	0x1b000000 - 0x1b00ffff	CF common mapping
*/

#define OCTEON_CF_ATTRIB_CHIP_SEL   2
#define OCTEON_CF_ATTRIB_BASE_ADDR  0x1b010000
#define OCTEON_CF_COMMON_CHIP_SEL   3
/* Address bit 11 selects common memory space for Compact flash accesses */
#define OCTEON_CF_COMMON_BASE_ADDR  (0x1b000000 | (1 << 11))
#define OCTEON_CHAR_LED_CHIP_SEL    4
#define OCTEON_CHAR_LED_BASE_ADDR   0x1a000000


/* SPD EEPROM addresses on Kodama board */
#define KODAMA_DIMM_0_SPD_TWSI_ADDR    0x50
/* #define KODAMA_EEPROM_TWSI_ADDR        0x52 -- Oops, not there. */
...
/*
** The Kodama does not use the internal arbiter in Octeon.
...
#undef OCTEON_KODAMA_RGMII_ENET
...
#ifdef CONFIG_OCTEON_FAILSAFE
#define	CFG_PROMPT		"Octeon Kodama Failsafe bootloader # "	/* Monitor Command Prompt    */
#else
#if CONFIG_RAM_RESIDENT
#define	CFG_PROMPT		"Octeon Kodama (ram)# "	/* Monitor Command Prompt    */
#else
#define	CFG_PROMPT		"Octeon Kodama # "	/* Monitor Command Prompt    */
#endif
#endif
...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
	...
	"linux_cf=fatload ide 0 100000 vmlinux.64;bootoctlinux 100000\0"				\
...
#define OCTEON_DDR_CLOCK_MHZ	266  /* Rev 1 boards are 400 (200), rev 2 are (can be) 533(266) */
#endif

/* Kodama has one DIMM socket.
*/
#define DRAM_SOCKET_CONFIGURATION \
	{KODAMA_DIMM_0_SPD_TWSI_ADDR, 0}
