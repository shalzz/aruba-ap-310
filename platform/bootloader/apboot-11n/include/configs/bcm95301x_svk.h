...
#define CONFIG_JFFS2_NAND_OFF 0x700000
#define CONFIG_JFFS2_NAND_SIZE 0x800000
...
#ifdef CONFIG_NAND_IPROC_BOOT /*wur*/
/* Enable NVRAM subsystem for MWG support*/
#define CONFIG_NVRAM_WL
#define CONFIG_NAND_FLASH_BASE_ADDR         0x1c000000
#define CONFIG_NVRAM_OFFSET                 0x180000
// #define CONFIG_NVRAM_OFFSET_REDUND          0x200000
#define CONFIG_NVRAM_PARTITION_SIZE         0x80000
#define CONFIG_NVRAM_SIZE                   0x4000
#define CONFIG_ENV_SIZE                     0x4000
#define CONFIG_SYS_PROMPT                   "n-boot> "
#else
#define CONFIG_NVRAM_WL
#define CONFIG_NVRAM_OFFSET                 0xF80000
// #define CONFIG_NVRAM_OFFSET_REDUND          0x200000
#define CONFIG_NVRAM_SIZE                   0x4000
#define CONFIG_NVRAM_PARTITION_SIZE         0x80000
#define CONFIG_ENV_SIZE                     0x4000
#undef CONFIG_SYS_PROMPT
#define CONFIG_SYS_PROMPT                   "s-boot> "
#endif
...
#define	CFG_FLASH_SIZE (16 * 1024 * 1024)	/* XXX */
...
#define CFG_MANUF_BASE      0x1efe0000
#define CFG_MFG_SIZE	    0x10000
//#define CFG_TPM_CERT 	    0x1efa0000
...
#define ARUBA_BOARD_TYPE	"BCM53012ER"
#define __MODEL_STR__		"AP-20x"
...
#define	AP_PRODUCTION_IMAGE		0x1e100000	/* avoid env */
#define	AP_PRODUCTION_IMAGE_SIZE	(7 * 1024 * 1024)
#define	AP_PROVISIONING_IMAGE		0x1e800000
