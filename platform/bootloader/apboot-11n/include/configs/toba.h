...
#define CFG_MANUF_NOR_BASE              0x370000
#define CFG_MFG_SIZE                    0x10000
#define CFG_ART_BASE                    0x320000
#define CFG_TPM_CERT                    0x360000
...
#ifndef __ASSEMBLY__
#include <compiler.h>
#include "../../board/qca/toba/ipq806x_cdp.h"
...
/* GPIO outputs */
#define GPIO_EXT_WDOG_POKE 2
/* for LEDs: low: on, high: off */
#define GPIO_RED_STATUS_LED 54
#define GPIO_GREEN_STATUS_LED 55
#define GPIO_AMBER_STATUS_LED 56
...
//#define GPIO_PHY_1_RST_L  /* Active low to reset PHY1 */
#define GPIO_PCIE_1_RST_L 3 /* Active low to reset PCIE 1 */
#define GPIO_PCIE_2_RST_L 48 /* Active low to reset PCIE 2 */

#define GPIO_POR_RST_CLK 24 /* pulse this bit low to set the warm reset status */
#define GPIO_WD_LATCH_CLR_L 58 /* pulse this bit low to reset watchdog status D flipflop */
//#define GPIO_USB_ENABLE 51 /* active low to enable power to USB port */
#define GPIO_BLE_RST_L 66 /* active low to reset BLE */
#define GPIO_WD_DISABLE 25 /* active low to disable external watchgod timer */
#define GPIO_TPM_RESET_L 16	/*active low to reset TPM chip*/


/* GPIO inputs */
#define GPIO_POWER_AT 23
#define GPIO_POWER_DC 65 /*Toba don't support DC supply, use this gpio as a pseudo DC pin, it always return 0,means no DC supply*/
#define GPIO_IPM_IRQ_L 22
//#define GPIO_POE_PRES_0 6 /* active low indicating POE source port 0 is present */
#define GPIO_CONFIG_CLEAR 53
#define GPIO_POR_STS_IN 63 /* active low indicating reset caused by cold HW reset */
#define GPIO_WD_STS_IN 57 /* active high indicating reset caused by ext watchdog */
