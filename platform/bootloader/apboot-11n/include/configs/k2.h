...
#elif (__K2_DRAM__ == 512)
#define CONFIG_SYS_SDRAM_SIZE_LAW	LAW_SIZE_512M
#else
#error "Unknown K2 DRAM size"
#endif
...
#elif defined(CONFIG_P1020UTM) || defined(CONFIG_K2)
...
#define CONFIG_DTT_SENSORS { 0x48, 0x49 }
...
#define ARUBA_BOARD_TYPE	"K2"
#define __MODEL_STR__		"AP-27x"
...
/* GPIO outputs */
#define GPIO_EXT_WDOG_POKE	3
#define GPIO_YELLOW_STATUS_LED	4
#define GPIO_RED_STATUS_LED	5
#define GPIO_GREEN_STATUS_LED	6
#define GPIO_PCI_RST0		7
#define GPIO_PCI_RST1		8

/* planned */
//#define GPIO_TPM_RST_L		11

/* GPIO inputs */
#define	GPIO_POWER_POE	2
#define	GPIO_POWER_DC		1
#define	GPIO_POWER_AT		13
