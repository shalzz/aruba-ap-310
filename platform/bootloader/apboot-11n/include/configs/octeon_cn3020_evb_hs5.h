...
/*
 * This file contains the configuration parameters for the Octeon CN3020_EVB_HS5 board.
 */
...
/* bootloader usable memory size in bytes for cn3020_evb_hs5, hard
...
#define CONFIG_COMMANDS		((CONFIG_CMD_DFL | CFG_CMD_ELF | CFG_CMD_OCTEON | CFG_CMD_LOADB | CFG_CMD_FLASH \
                                  ...
                                  | CFG_CMD_ASKENV | CFG_CMD_NET | CFG_CMD_DHCP | CFG_CMD_PING | CFG_CMD_MII | PCI_CONFIG_COMMANDS)\
...
#ifdef CONFIG_OCTEON_FAILSAFE
#define	CFG_PROMPT		"Octeon cn3020_evb_hs5 Failsafe bootloader# "	/* Monitor Command Prompt    */
#else
#if CONFIG_RAM_RESIDENT
#define	CFG_PROMPT		"Octeon cn3020_evb_hs5(ram)# "	/* Monitor Command Prompt    */
#else
#define	CFG_PROMPT		"Octeon cn3020_evb_hs5# "	/* Monitor Command Prompt    */
#endif
#endif
...
/* CN3020_EVB_HS5 has two DIMM sockets. DIMM 0 must be populated.
*/
