...
/* EBT3000 uses configuration eeprom */
...
#define BOARD_EEPROM_TWSI_ADDR        OCTEON_EBT3000_EEPROM_ADDR
...
/*
** The EBT3000 does not use the internal arbiter in Octeon.
...
#ifdef CONFIG_OCTEON_FAILSAFE
#define	CFG_PROMPT		"Octeon ebt3000 Failsafe bootloader# "	/* Monitor Command Prompt    */
#else
#if CONFIG_RAM_RESIDENT
#define	CFG_PROMPT		"Octeon ebt3000(ram)# "	/* Monitor Command Prompt    */
#else
#define	CFG_PROMPT		"Octeon ebt3000# "	/* Monitor Command Prompt    */
#endif
#endif
...
*/
#define DRAM_SOCKET_CONFIGURATION OCTEON_EBT3000_DRAM_SOCKET_CONFIGURATION
...
#define DDR_BOARD_DELAY		OCTEON_EBT3000_DDR_BOARD_DELAY
