...
#define CONFIG_NEBBIOLO     1
#define CONFIG_MIPS32		1	/* MIPS 5Kc CPU core	*/
#define CONFIG_PURPLE		1	/* on a PURPLE Board	*/

#define MIN_CPU_CLK     500
#define MAX_CPU_CLK     1200
#define CPU_CLOCK_RATE	1000000000ULL   /* 125 MHz clock for the MIPS core */
...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
	...
	"update=protect off 1:0-4;era 1:0-4;"				\
		...
		"ipaddr 10.3.4.210\0"			\
		"serverip 10.3.4.191\0"			\
	""
#endif

#define CONFIG_BOOTCOMMAND	"tftp"

#define CONFIG_COMMANDS	(CONFIG_CMD_DFL|CFG_CMD_PING|CFG_CMD_NET|CFG_CMD_IDE|CFG_CMD_EXT2|CFG_CMD_NEB_FLASH)
//#define CONFIG_COMMANDS	(CONFIG_CMD_DFL|CFG_CMD_ELF|CFG_CMD_PING|CFG_CMD_NET|CFG_CMD_IDE|CFG_CMD_EXT2|CFG_CMD_PCMCIA)
#include <cmd_confdefs.h>

#define CFG_LONGHELP
#define CFG_SDRAM_BASE		0x80000000

#define CFG_INIT_SP_OFFSET_H      0x8c00
#define CFG_INIT_SP_OFFSET_L      0x8000
#define CFG_INIT_SP_OFFSET      0x400000

#define CFG_MALLOC_LEN		128*1024

#define CFG_BOOTPARAMS_LEN	1*1024
...
#define	CFG_LOAD_ADDR		0x87000000	/* default load address	*/
...
#define CFG_ENV_ADDR		0xBc1e0000
#define CFG_ENV_SIZE		0x20000

#define CONFIG_FLASH_32BIT
#define CONFIG_NR_DRAM_BANKS	1

#define CONFIG_XLR732_ETHER
...
#define CFG_ATA_ALT_OFFSET  0x01f0
#define CFG_ATA_REG_OFFSET  0x01f0
#define CFG_ATA_BASE_ADDR   0xbd000000
#define CFG_ATA_DATA_OFFSET 0x01f0
