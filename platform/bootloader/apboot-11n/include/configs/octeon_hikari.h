...
/*
 * This file contains the configuration parameters for the CN3120 Hikari board.
 */
...
#define CONFIG_OCTEON_31XX	1
/* CONFIG_OCTEON_HIKARI set by Makefile in include/config.h */
...
/* bootloader usable memory size in bytes for Hikari, hard code until autodetect */
...
/* Boot bus memory map:
**	0x1bc00000 - 0x1ff00000	Boot flash + bottom 4MB aliased at top
*/


/* TWSI EERPOM used for board information */
#define BOARD_EEPROM_TWSI_ADDR          0x50
...
/*
** The Hikari does not use the internal arbiter in Octeon.
...
#undef OCTEON_HIKARI_RGMII_ENET
...
#define EXTRA_EXCLUDE_COMMANDS   (CFG_CMD_NET | CFG_CMD_DHCP | CFG_CMD_PING )
#elif  defined(OCTEON_INTERNAL_ENET)
#define EXTRA_INCLUDE_COMMANDS   (CFG_CMD_NET | CFG_CMD_DHCP | CFG_CMD_MII | CFG_CMD_PING)
#define EXTRA_EXCLUDE_COMMANDS   (0)
#else
#define EXTRA_INCLUDE_COMMANDS   (0)
#define EXTRA_EXCLUDE_COMMANDS   (CFG_CMD_NET | CFG_CMD_DHCP | CFG_CMD_MII | CFG_CMD_PING )
#endif
...
#define CONFIG_COMMANDS		((CONFIG_CMD_DFL | CFG_CMD_ELF | CFG_CMD_OCTEON | CFG_CMD_LOADB | CFG_CMD_FLASH \
                                  | CFG_CMD_ENV | CFG_CMD_FLASH | CFG_CMD_RUN | CFG_CMD_EEPROM \
...
#ifdef CONFIG_OCTEON_FAILSAFE
#define	CFG_PROMPT		"Octeon Hikari Failsafe # "	/* Monitor Command Prompt    */
#else
#if CONFIG_RAM_RESIDENT
#define	CFG_PROMPT		"Octeon Hikari (ram)# "	/* Monitor Command Prompt    */
#else
#define	CFG_PROMPT		"Octeon Hikari # "	/* Monitor Command Prompt    */
#endif
#endif
...
#if defined(HIKARI_FLASH_64MB)
#define CFG_FLASH_SIZE	(64*1024*1024)	/* Flash size (bytes) */
#define CFG_MAX_FLASH_BANKS	1	/* max number of memory banks */
#define CFG_MAX_FLASH_SECT	(512)	/* max number of sectors on one chip */

#define	CONFIG_EXTRA_ENV_SETTINGS					\
	"bootloader_flash_update=protect off 0xbbc40000 0xbbc7ffff;erase 0xbbc40000 0xbbc7ffff;cp.b 0x100000 0xbbc40000 0x40000\0"				\
	"burn_app=erase BBC80000 +$(filesize);cp.b 100000 BBC80000 $(filesize)\0"				\
	"bf=bootoct BBC80000 forceboot numcores=$(numcores)\0"				\
	"nuke_env=protect off BFBE0000 BFBFFFFF; erase BFBE0000 BFBFFFFF\0"				\
	"autoload=n\0"					\
	""
#else
#define CFG_FLASH_SIZE	(32*1024*1024)	/* Flash size (bytes) */
#define CFG_MAX_FLASH_BANKS	1	/* max number of memory banks */
#define CFG_MAX_FLASH_SECT	(256)	/* max number of sectors on one chip */

#define	CONFIG_EXTRA_ENV_SETTINGS					\
	"bootloader_flash_update=protect off 0xbdc40000 0xbdc7ffff;erase 0xbdc40000 0xbdc7ffff;cp.b 0x100000 0xbdc40000 0x40000\0"				\
...
#define PHYS_FLASH_1		(0xbfc00000 - CFG_FLASH_SIZE) /* Flash Bank #1 */
...
/* Address and size of Primary Environment Sector, needs to be full flash sector	*/
#define CFG_ENV_SIZE		(128*1024)

/* The last block in the flash is the environment sector */
#define CFG_ENV_ADDR		(0xbfc00000 - CFG_ENV_SIZE)
...
/* Define DRAM config with bogus device addresses, as code expects twsii device addresses */
...
** DIMM interface.
*/
#define STATIC_DRAM_CONFIG_TABLE static_ddr2_spd_data_k4t51163qc_zcd5
#endif

/* Board skew in picoseconds */
#define DDR_BOARD_DELAY 2500
/* 1500 worked @ 400 MHz */
