...
#define CFG_DDR_REFRESH_VAL     		0x461b		// 0xB8000014
...
/* Disable PCI init for MSR4K */
#if (!defined(CONFIG_MSR_SUBTYPE)) || (defined(CONFIG_MSR_SUBTYPE) && (CONFIG_MSR_SUBTYPE != 4000))
#define CONFIG_NOT_MSR4K_TYPE
#define CONFIG_PCI
...
#define CONFIG_COMMANDS (( CONFIG_CMD_DFL        | CFG_CMD_MII   | CFG_CMD_PING  \
   | CFG_CMD_NET | CFG_CMD_PCI     | CFG_CMD_ENV | CFG_CMD_FLASH | CFG_CMD_I2C  \
...
/* MST200AC uses Marvell PHY */
#if (CONFIG_MSR_SUBTYPE == 201)
#define CFG_MV88E1XXX_PHY			1
#else
...
#if (CONFIG_MSR_SUBTYPE == 1200)
#define __MODEL_STR__ "MSR1200"
#define ARUBA_BOARD_TYPE	"MSR1200"
#define AR7100_DUALFLASH_SUPPORT	1
#define	CONFIG_EXTRA_ENV_SETTINGS			\
	...
	""
#elif (CONFIG_MSR_SUBTYPE == 2000)
#define __MODEL_STR__ "MSR2000"
#define ARUBA_BOARD_TYPE	"MSR2000"
#define AR7100_DUALFLASH_SUPPORT	1
#define	CONFIG_EXTRA_ENV_SETTINGS			\
	"autoload=n\0"					\
	"boardname=MSR2000\0"				\
	...
	"bootfile=mips32.ari\0"			        \
	""
#elif (CONFIG_MSR_SUBTYPE == 4000)
#define __MODEL_STR__ "MSR4000"
#define ARUBA_BOARD_TYPE	"MSR4000"
#define AR7100_DUALFLASH_SUPPORT	1
#define	CONFIG_EXTRA_ENV_SETTINGS			\
	"autoload=n\0"					\
	"boardname=MSR4000\0"				\
	...
	"bootfile=mips32.ari\0"			        \
	""
#elif (CONFIG_MSR_SUBTYPE == 200)
#define __MODEL_STR__ "MST200"
#define ARUBA_BOARD_TYPE	"MST200"
#define AR7100_DUALFLASH_SUPPORT	1
#define	CONFIG_EXTRA_ENV_SETTINGS			\
	"autoload=n\0"					\
	"boardname=MST200\0"				\
	...
	"bootfile=mips32.ari\0"			        \
	""
#elif (CONFIG_MSR_SUBTYPE == 201)
#define __MODEL_STR__ "MST200AC"
#define ARUBA_BOARD_TYPE	"MST200AC"
#define AR7100_DUALFLASH_SUPPORT	1
#define	CONFIG_EXTRA_ENV_SETTINGS			\
	"autoload=n\0"					\
	"boardname=MST200AC\0"				\
	"servername=aruba-master\0"			\
	"bootcmd=boot ap\0"			        \
	"autostart=yes\0"			        \
	"bootfile=mips32.ari\0"			        \
	""
#else
#error "Unsupported MSR_SUBTYPE"
#endif /* CONFIG_MSR_SUBTYPE */ 
#else
#define __MODEL_STR__ "AP-175X"
#define ARUBA_BOARD_TYPE	"MSR2K"
#define	CONFIG_EXTRA_ENV_SETTINGS			\
	"autoload=n\0"					\
	"boardname=MSR2K\0"				\
	"servername=aruba-master\0"			\
	...
	"bootfile=mips32.ari\0"			        \
	""
#endif /* defined(CONFIG_MSR_SUBTYPE) */
...
#define	GPIO_2G_GREEN_LED	3
#define	GPIO_5G_GREEN_LED	4
