...
#define CONFIG_COMMANDS ((CFG_CMD_DFL | CFG_CMD_DHCP | CFG_CMD_ELF | CFG_CMD_PCI | CFG_CMD_MEMORY | CMD_CMD_PORTIO | CFG_CMD_ITEST | CFG_CMD_NET | CFG_CMD_PING  |CFG_CMD_FLASH |CFG_CMD_ENV | CFG_CMD_NAND | CFG_CMD_UBI) | CFG_CMD_MII | CFG_CMD_I2C)
...
#define CFG_NAND_BASE                   0 /* fixme_eiger */
...
#define EIGER_I2C_CHIP_IOEXP             0x20
#define EIGER_I2C_CHIP_TPM               0x29
#define EIGER_I2C_CHIP_RTC               0x68
#define EIGER_I2C_CHIP_TEMP_SENSOR       0x48
#define EIGER_I2C_CHIP_SFP               0x50


/*
 * GPIOs on I2C
 */
#define GPIO_SFP_TX_FAULT                0
#define GPIO_SFP_TX_DIS                  1
#define GPIO_SFP_RATE_SEL                2
#define GPIO_SFP_LOS                     3
#define GPIO_SFP_PST_L                   4
#define GPIO_SFP_PWR_EN                  5
#define GPIO_TPM_RST_L                   7
#define GPIO_TEMP_ALARM_L                8
#define GPIO_CM_RST_L                    9
#define GPIO_SYS_RST_L                   10
#define GPIO_2G_QCA_PWR_DOWN_L           13
#define GPIO_5G_QCA_PWR_DOWN_L           15


#ifndef __ASSEMBLY__
#include <compiler.h>
#include "../../board/qca/eiger/ipq806x_cdp.h"
...
#define CONFIG_BOOTARGS                 "console=ttyHSL1,9600n8"
...
/* GPIO outputs */
#define GPIO_HW_RESET 68   /* Active low to force system HW reset */
...
#define GPIO_FAULT_LED 26
#define GPIO_OPERATIONAL_LED 55
#define GPIO_RADIO_LED 56
#define GPIO_CM_LED 57
#define GPIO_ETHERNET_LED 58

#define GPIO_QFPROM_EN 66 /* drive low to power off VDD_QFPROM_BLOW */
#define GPIO_GPS_AUX_LDO_EN 2

/* GPIO inputs */
#define GPIO_POWER_AT 59
#define GPIO_CONFIG_CLEAR 53
#define GPIO_IOEXP_INT 64
#define GPIO_IOEXP_RST_L 65 /* Active low to reset I2C I/O expander */
#define GPIO_SFP_POWER_FAIL 63 /* active low indicating SFP power fault */
#define GPIO_PHY0_INT 15
#define GPIO_GPS_EN 54
