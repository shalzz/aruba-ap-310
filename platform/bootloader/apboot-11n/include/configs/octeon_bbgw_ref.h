...
/*
 * This file contains the configuration parameters for the Octeon CN50XX BB Reference board.
 */
...
/* CN3010_EVB_HS5 uses configuration eeprom */
...
/* SPD EEPROM address */
#define BOARD_EEPROM_TWSI_ADDR        0x52
...
#define CFG_FAILSAFE_BOOTLOADER_SIZE  (CFG_NORMAL_BOOTLOADER_BASE - 0xbfc00000)
...
#define CONFIG_COMMANDS		((CONFIG_CMD_DFL | CFG_CMD_ELF | CFG_CMD_OCTEON | CFG_CMD_LOADB | CFG_CMD_FLASH \
                                  ...
                                  & ~(FAILSAFE_EXCLUDE_COMMANDS | CFG_CMD_FPGA | CFG_CMD_BDI \
                                   | CFG_CMD_BEDBUG | CFG_CMD_BOOTD | CFG_CMD_LOADS | CFG_CMD_NFS | CFG_CMD_AUTOSCRIPT))
...
#ifdef CONFIG_OCTEON_FAILSAFE
#define	CFG_PROMPT		"Octeon bbgw_ref Failsafe bootloader# "	/* Monitor Command Prompt    */
#else
#if CONFIG_RAM_RESIDENT
#define	CFG_PROMPT		"Octeon bbgw_ref(ram)# "	/* Monitor Command Prompt    */
#else
...
#define CFG_FLASH_PROTECT_LEN   0xA0000  /* protect low 640K */
...
#define LMC_DELAY_CLK  6
#define LMC_DELAY_CMD  0
#define LMC_DELAY_DQ   8

#define	APBOOT_SIZE	(1024 * 1024)
#define ARUBA_HEADER_SIZE	512
#define CFG_TFTP_STAGING_AREA   (22 * 1024 * 1024)	/* same as Moscato */

#ifndef __BOOT_IMAGE_TYPE 
#define __BOOT_IMAGE_TYPE ARUBA_IMAGE_MOSCATO
#endif

#define CFG_MANUF_BASE (CFG_FLASH_BASE + CFG_FLASH_SIZE - (CFG_ENV_SIZE * 2))
#define CFG_MANUF_SIZE (128 * 1024)
#define CFG_MFG_SIZE CFG_MANUF_SIZE
...
#define ARUBA_BOARD_TYPE "BBGW"
#endif

#define	CONFIG_NO_MULTI_BOOT	1

#define nvram_manuf_t std_manuf_t

#define	AP_PRODUCTION_IMAGE_SIZE	(7 * 1024 * 1024)

#define __MODEL_STR__ 	"BBGW Development Board"

#define	CONFIG_OCTEON_NUMCORE_OVERRIDE	2

#define	__TLV_INVENTORY__		1
#define INVENT_MAX_INVENTORIES		1
#define __TLV_INVENTORY_BUF_SIZE__	1024
/* for BBGW, the variant is on the base board */
