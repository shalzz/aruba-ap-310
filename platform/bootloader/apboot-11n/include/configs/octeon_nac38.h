...
/* bootloader usable memory size in bytes for na-c38, hard code until autodetect */
...
#ifdef CONFIG_OCTEON_FAILSAFE
#define	CFG_PROMPT		"Octeon NA-C38 Failsafe bootloader# "	/* Monitor Command Prompt    */
#else
#if CONFIG_RAM_RESIDENT
#define	CFG_PROMPT		"Octeon NA-C38(ram)# "	/* Monitor Command Prompt    */
#else
#define	CFG_PROMPT		"Octeon NA-C38# "	/* Monitor Command Prompt    */
#endif
#endif
...
/* NA-C38 has two pairs of DIMM sockets. DIMM A1A must be populated.
