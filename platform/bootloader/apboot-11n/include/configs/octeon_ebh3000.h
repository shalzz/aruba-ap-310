...
/*
 * This file contains the configuration parameters for the Octeon EBH3000 board.
 */
...
/* CONFIG_OCTEON_EBH3000 set by Makefile in include/config.h */ 
...
#define EBH3000_REV1_DEF_DRAM_FREQ  266
...
/* EBH3000 uses configuration eeprom */
...
/* bootloader usable memory size in bytes for ebh3000, hard code until autodetect */
...
/* SPD EEPROM addresses on EBH3000 board */
#define BOARD_DIMM_0_SPD_TWSI_ADDR    0x50
#define BOARD_DIMM_1_SPD_TWSI_ADDR    0x51
#define BOARD_DIMM_2_SPD_TWSI_ADDR    0x52
#define BOARD_DIMM_3_SPD_TWSI_ADDR    0x53
...
#ifdef CONFIG_OCTEON_FAILSAFE
#define	CFG_PROMPT		"Octeon ebh3000 Failsafe bootloader# "	/* Monitor Command Prompt    */
#else
#if CONFIG_RAM_RESIDENT
#define	CFG_PROMPT		"Octeon ebh3000(ram)# "	/* Monitor Command Prompt    */
#else
#define	CFG_PROMPT		"Octeon ebh3000# "	/* Monitor Command Prompt    */
#endif
#endif
...
/* EBH3000 has two pairs of DIMM sockets. DIMM 0 must be populated.
** Populating DIMM 1 enables the 128/144-bit interface.
*/
#define DRAM_SOCKET_CONFIGURATION \
	{BOARD_DIMM_0_SPD_TWSI_ADDR, BOARD_DIMM_2_SPD_TWSI_ADDR}, \
	{BOARD_DIMM_1_SPD_TWSI_ADDR, BOARD_DIMM_3_SPD_TWSI_ADDR}
