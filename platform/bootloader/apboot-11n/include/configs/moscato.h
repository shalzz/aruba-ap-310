...
#define CFG_HZ			400000000ull      /* FIXME causes overflow in net.c */
...
#ifndef CONFIG_STAGE1
#define CONFIG_RTC_DS1374   1       // Moscato uses ds1374
#define CONFIG_DTT_LM75     1       // temp for bringup
#endif
#define CONFIG_DTT_SENSORS  {0x48}  // LM75 devid (temp for bringup)
...
#define	CONFIG_MARVELL_6063
#endif

#define CFG_DRAM_TEST		1

#define	__MODEL_STR__	"RAP-5x"

#define	GPIO_RED_STATUS_LED	0
#define	GPIO_GREEN_STATUS_LED	1
#define	GPIO_PHY_0_RESET	2
#define GPIO_LAN_SW_RESET	3
#define	GPIO_RADIO_0_RESET	4
#define GPIO_CONFIG_CLEAR       5
#define GPIO_5G_RED_LED         6
#define GPIO_5G_GREEN_LED       7
#define GPIO_CARD_ID_0         13
#define GPIO_CARD_ID_1         14
#define GPIO_CARD_ID_2         15
#define	GPIO_NOT_3005	       16
#define GPIO_2G_RED_LED        17
#define GPIO_2G_GREEN_LED      18
#define	GPIO_TPM_CLK	       19
#define	GPIO_TPM_DATA	       20

#define ARUBA_BOARD_TYPE	"Moscato"

#define	ARUBA_5010_DDR_MHZ	266
#define	__DDR_NCOLS	10
#define	__DDR2T 1
#define	__DDR_TRRD 10000
#define	__DDR_CTL_ODT_MASK	0x01
#define __DDR_TRAS	45000
#define	__DDR_REFINT	4
#define	__DDR_SILO_QC	1
#define __DDR_QS_DIC	1
#define	__DDR_TRFC	105000

#define	CONFIG_RESET_BUTTON

// this is a hack; I could not get u-boot to build
// without MULTI_NET support, so this disables it
// for Moscato
...
#define CN5010_PLL_LOCK_WAR	1

#ifdef CONFIG_STAGE1
#define CONFIG_BZIP2 1
#endif

#define STAGE2_RAM_ADDRESS 0x7e00000
