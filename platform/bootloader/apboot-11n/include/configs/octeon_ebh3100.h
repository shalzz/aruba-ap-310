...
/*
 * This file contains the configuration parameters for the Octeon EBH3100 board.
 */
...
/* CONFIG_OCTEON_EBH3100 set by Makefile in include/config.h */ 
...
#define EBH3100_REV1_DEF_DRAM_FREQ  266
...
/* EBH3100 uses configuration eeprom */
...
/* bootloader usable memory size in bytes for ebh3100, hard code until autodetect */
...
/* SPD EEPROM addresses on EBH3100 board */
...
#ifdef CONFIG_OCTEON_FAILSAFE
#define	CFG_PROMPT		"Octeon ebh3100 Failsafe bootloader# "	/* Monitor Command Prompt    */
#else
#if CONFIG_RAM_RESIDENT
#define	CFG_PROMPT		"Octeon ebh3100(ram)# "	/* Monitor Command Prompt    */
#else
#define	CFG_PROMPT		"Octeon ebh3100# "	/* Monitor Command Prompt    */
#endif
#endif
...
/* EBH3100 has two DIMM sockets. DIMM 0 must be populated.
*/
...
#define DDR_BOARD_DELAY_REV_1		4200
#define DDR_BOARD_DELAY_REV_2		6000
