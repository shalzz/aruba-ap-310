...
#define CONFIG_BOARDNAME "TOMATIN"
...
#else
#error "Unknown Tomatin DRAM size"
#endif
...
#define CONFIG_SYS_FLASH_SIZE           (64 * 1024 * 1024)
#elif defined(CONFIG_P1020UTM) || defined(CONFIG_TOMATIN)
#if (__TOMATIN_FLASH__ == 16)  /* 16MB flash */
#define CONFIG_FDT_FIXUP_NOR_FLASH_SIZE 1
...
#define CONFIG_SYS_NOR_CSPR	(CSPR_PHYS_ADDR(CONFIG_SYS_FLASH_BASE_PHYS) | \
				...
				CSPR_MSEL_NOR | \
				CSPR_V)
#define CONFIG_SYS_NOR_AMASK	IFC_AMASK(CONFIG_SYS_FLASH_SIZE)
...
/* 88E1510 PHY Page Register */
#define MIIM_88E1510_PHY_PAGE		22

/* 88E1510 PHY MAC Specific Control Register 2 (page2) */
#define MIIM_88E1510_PHY_MAC_SPEC_CONTROL2			21
#define MIIM_88E1510_RGMII_RX_TIMING_CONTROL_MASK	5
#define MIIM_88E1510_RGMII_TX_TIMING_CONTROL_MASK	4

/* 88E1510 PHY LED Control Register (page3) */
#define MIIM_88E1510_PHY_LED_FUNCTION_CONTROL		16
#define MIIM_88E1510_PHY_LED_POLARITY_CONTROL		17
#define MDIO_DEVAD_NONE 0
...
#if (__TOMATIN_FLASH__ == 16)  /* 16M flash */
#define CONFIG_SYS_AP_PRODUCTION_IMAGE 0xef000000
#define CONFIG_SYS_AP_PRODUCTION_IMAGE_SIZE (10 * 1024 * 1024) /* 10M  */
#define CONFIG_SYS_AP_PROVISIONING_IMAGE 0xefa00000
#define CONFIG_SYS_AP_PROVISIONING_IMAGE_SIZE (4 * 1024 * 1024) /* 4MB */
#else
#define CONFIG_SYS_AP_PRODUCTION_IMAGE 0xee000000
#define CONFIG_SYS_AP_PRODUCTION_IMAGE_SIZE (14 * 1024 * 1024) /* 14MB */
#define CONFIG_SYS_AP_PROVISIONING_IMAGE 0xeee00000
...
#define ARUBA_BOARD_TYPE	"Tomatin"
#define __MODEL_STR__		"AP-21x"
...
#define CONFIG_PHY_MV151x
#define __BOARD_HAS_POWER_INFO__

/* GPIO outputs */
#define GPIO_USB_PWR		1
#define GPIO_RED_STATUS_LED	5
#define GPIO_GREEN_STATUS_LED	4
#define GPIO_PCI_RST_2G		7
#define GPIO_PCI_RST_5G		6


/* GPIO inputs */
#define	GPIO_POWER_POE_PLUS	10
#define	GPIO_POWER_DC		9
#define	GPIO_POWER_AT		8

#define	GPIO_CONFIG_CLEAR	11

#define TOMATIN_REV_A_PHY_WAR
