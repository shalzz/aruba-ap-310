...
#define	CFG_PROMPT		"Octeon cn3010_evb_hs5(ram)# "	/* Monitor Command Prompt    */
#else
#define	CFG_PROMPT		"Octeon cn3010_evb_hs5# "	/* Monitor Command Prompt    */
#endif
#endif
...
#define CFG_TFTP_STAGING_AREA   (0x21000000)
