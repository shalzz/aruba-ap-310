...
#ifdef CONFIG_OCTEON
	int  (*readl)  (unsigned int);		/* Read access function */
	void (*writel) (int, unsigned int);	/* Write access function */
	int  (*readw)  (unsigned int);		/* Read access function */
	void (*writew) (int, unsigned int);	/* Write access function */
#endif /* CONFIG_OCTEON */
...
extern __inline__ void pci_set_region(struct pci_region *reg,
				      ...
				      void (*writel) (int, unsigned int),
				      int  (*readw)  (unsigned int), 
				      void (*writew) (int, unsigned int),
#endif /* CONFIG_OCTEON */
...
#ifdef CONFIG_OCTEON
extern void *get_region_access_function(struct pci_controller* hose,
				   unsigned long bus_addr,
					unsigned long flags, int read, int size);
#endif /* CONFIG_OCTEON */
