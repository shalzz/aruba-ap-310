...
#ifdef CONFIG_HW_WATCHDOG_INTERNAL
	#if defined(__ASSEMBLY__)
		#define WATCHDOG_RESET_INTERNAL bl hw_watchdog_reset_internal
	#else
		extern void hw_watchdog_reset_internal(void);

		#define WATCHDOG_RESET_INTERNAL hw_watchdog_reset_internal
	#endif /* __ASSEMBLY__ */
#else
	#define WATCHDOG_RESET_INTERNAL WATCHDOG_RESET
#endif
