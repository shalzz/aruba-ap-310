/* copied from 9.2.0.717 Linux 2.6.31 for use with ar934x_sys_frequency */
...
/* Undefine everything in this file (search for "Address map" to skip) */
#undef AHB_DIV_MASK
#undef AHB_DIV_SHIFT
#undef ATH_APB_BASE
#undef ATH_AR9341_1_0
#undef ATH_AR9341_1_1
#undef ATH_AR9341_1_x
#undef ATH_AR9342_1_0
#undef ATH_AR9342_1_1
#undef ATH_AR9342_1_x
#undef ATH_AR9344_1_0
#undef ATH_AR9344_1_1
#undef ATH_AR9344_1_x
#undef ath_arch_init_irq
#undef ATH_AUDIO_PLL_CONFIG
#undef ATH_BOOTSTRAP_REG
#undef ATH_CFG_CMD_READ
#undef ATH_CFG_CMD_WRITE
#undef ATH_CPU_BASE
#undef ATH_CPU_IRQ_BASE
#undef ATH_CPU_IRQ_GE0
#undef ATH_CPU_IRQ_GE1
#undef ATH_CPU_IRQ_MISC
#undef ATH_CPU_IRQ_PCI
#undef ATH_CPU_IRQ_PCI_EP
#undef ATH_CPU_IRQ_TIMER
#undef ATH_CPU_IRQ_USB
#undef ATH_CPU_IRQ_WLAN
#undef ATH_CRP_CMD_READ
#undef ATH_CRP_CMD_WRITE
#undef ATH_DDR_CLK_CTRL
#undef ATH_DDR_CONFIG
#undef ATH_DDR_CONFIG_16BIT
#undef ATH_DDR_CONFIG2
#undef ATH_DDR_CONFIG2_BL2
#undef ATH_DDR_CONFIG2_BL4
#undef ATH_DDR_CONFIG2_BL8
#undef ATH_DDR_CONFIG2_BT_IL
#undef ATH_DDR_CONFIG2_CNTL_OE_EN
#undef ATH_DDR_CONFIG2_DRAM_CKE
#undef ATH_DDR_CONFIG2_HALF_WIDTH_L
#undef ATH_DDR_CONFIG2_PHASE_SEL
#undef ATH_DDR_CONFIG2_TRTP_SHIFT
#undef ATH_DDR_CONFIG2_TRTW_SHIFT
#undef ATH_DDR_CONFIG2_TWR_SHIFT
#undef ATH_DDR_CONFIG2_TWTR_SHIFT
#undef ATH_DDR_CONFIG_CAS_LAT_SHIFT
#undef ATH_DDR_CONFIG_PAGE_OPEN
#undef ATH_DDR_CONFIG_TMRD_SHIFT
#undef ATH_DDR_CONFIG_TRAS_SHIFT
#undef ATH_DDR_CONFIG_TRCD_SHIFT
#undef ATH_DDR_CONFIG_TRFC_SHIFT
#undef ATH_DDR_CONFIG_TRP_SHIFT
#undef ATH_DDR_CONFIG_TRRD_SHIFT
#undef ATH_DDR_CONTROL
#undef ATH_DDR_CTL_BASE
#undef ATH_DDR_EXT_MODE
#undef ATH_DDR_GE0_FLUSH
#undef ATH_DDR_GE1_FLUSH
#undef ATH_DDR_MODE
#undef ATH_DDR_PCIE_FLUSH
#undef ATH_DDR_PLL_CONFIG
#undef ATH_DDR_RD_DATA_THIS_CYCLE
#undef ATH_DDR_REFRESH
#undef ATH_DDR_TAP_CONTROL0
#undef ATH_DDR_TAP_CONTROL1
#undef ATH_DDR_TAP_CONTROL2
#undef ATH_DDR_TAP_CONTROL3
#undef ATH_DDR_TAP_DEFAULT
#undef ATH_DDR_USB_FLUSH
#undef ATH_DDR_WIDTH_32
#undef ATH_DMA_BASE
#undef ATH_DMA_BUF_SIZE_128X2
#undef ATH_DMA_BUF_SIZE_16X2
#undef ATH_DMA_BUF_SIZE_256X2
#undef ATH_DMA_BUF_SIZE_32X2
#undef ATH_DMA_BUF_SIZE_4X2
#undef ATH_DMA_BUF_SIZE_512X2
#undef ATH_DMA_BUF_SIZE_64X2
#undef ATH_DMA_BUF_SIZE_8X2
#undef ATH_DMA_CHAN_SLIC0_RX
#undef ATH_DMA_CHAN_SLIC0_TX
#undef ATH_DMA_CHAN_SLIC1_RX
#undef ATH_DMA_CHAN_SLIC1_TX
#undef ATH_DMA_CHAN_STEREO_RX
#undef ATH_DMA_CHAN_STEREO_TX
#undef ATH_EEPROM_GE0_MAC_ADDR
#undef ATH_EEPROM_GE1_MAC_ADDR
#undef ATH_ETH_INT0_CLK
#undef ATH_ETH_INT1_CLK
#undef ATH_ETH_XMII_CONFIG
#undef ath_flush_ge
#undef ath_flush_pcie
#undef ath_flush_USB
#undef ATH_FRAC_FREQ_CONFIG
#undef ATH_GE0_BASE
#undef ATH_GE1_BASE
#undef ATH_GENERAL_TMR
#undef ATH_GENERAL_TMR_RELOAD
#undef ATH_GLOBAL_INT_STATUS
#undef ATH_GPIO_BASE
#undef ATH_GPIO_CLEAR
#undef ATH_GPIO_FUNCTION_2_EN_I2SCK_ON_1
#undef ATH_GPIO_FUNCTION_2_EN_I2WS_ON_0
#undef ATH_GPIO_FUNCTION_2_I2S_ON_LED
#undef ATH_GPIO_FUNCTION_CLK_OBS0_ENABLE
#undef ATH_GPIO_FUNCTION_CLK_OBS1_ENABLE
#undef ATH_GPIO_FUNCTION_CLK_OBS2_ENABLE
#undef ATH_GPIO_FUNCTION_CLK_OBS3_ENABLE
#undef ATH_GPIO_FUNCTION_CLK_OBS4_ENABLE
#undef ATH_GPIO_FUNCTION_CLK_OBS5_ENABLE
#undef ATH_GPIO_FUNCTION_CLK_OBS6_ENABLE
#undef ATH_GPIO_FUNCTION_DDR_DQOE_EN
#undef ATH_GPIO_FUNCTION_ETH_SWITCH_LED0_EN
#undef ATH_GPIO_FUNCTION_ETH_SWITCH_LED1_EN
#undef ATH_GPIO_FUNCTION_ETH_SWITCH_LED2_EN
#undef ATH_GPIO_FUNCTION_ETH_SWITCH_LED3_EN
#undef ATH_GPIO_FUNCTION_ETH_SWITCH_LED4_EN
#undef ATH_GPIO_FUNCTION_ETH_SWITCH_LED_ACTV
#undef ATH_GPIO_FUNCTION_ETH_SWITCH_LED_COLL
#undef ATH_GPIO_FUNCTION_ETH_SWITCH_LED_DUPL_EN
#undef ATH_GPIO_FUNCTION_EXT_MDIO_SEL
#undef ATH_GPIO_FUNCTION_I2S0_EN
#undef ATH_GPIO_FUNCTION_I2S_GPIO_18_22_EN
#undef ATH_GPIO_FUNCTION_I2S_MCKEN
#undef ATH_GPIO_FUNCTION_I2S_REFCLKEN
#undef ATH_GPIO_FUNCTION_JTAG_DISABLE
#undef ATH_GPIO_FUNCTION_OVERCURRENT_EN
#undef ATH_GPIO_FUNCTION_PCIEPHY_TST_EN
#undef ATH_GPIO_FUNCTION_PLL_SHIFT_EN
#undef ATH_GPIO_FUNCTIONS
#undef ATH_GPIO_FUNCTION_S26_UART_DISABLE
#undef ATH_GPIO_FUNCTION_SLIC_EN
#undef ATH_GPIO_FUNCTION_SPDIF2TCK_EN
#undef ATH_GPIO_FUNCTION_SPDIF_EN
#undef ATH_GPIO_FUNCTION_SPI_CS_0_EN
#undef ATH_GPIO_FUNCTION_SPI_CS_1_EN
#undef ATH_GPIO_FUNCTION_SPI_EN
#undef ATH_GPIO_FUNCTION_SRIF_ENABLE
#undef ATH_GPIO_FUNCTION_STEREO_EN
#undef ATH_GPIO_FUNCTION_UART_EN
#undef ATH_GPIO_FUNCTION_UART_RTS_CTS_EN
#undef ATH_GPIO_FUNCTION_USB_CLK_CORE_EN
#undef ATH_GPIO_FUNCTION_USB_LED
#undef ATH_GPIO_FUNCTION_WMAC_LED
#undef ATH_GPIO_IN
#undef ATH_GPIO_IN_ENABLE0
#undef ATH_GPIO_IN_ENABLE0_SPI_DATA_IN
#undef ATH_GPIO_IN_ENABLE0_UART_SIN
#undef ATH_GPIO_IN_ENABLE1
#undef ATH_GPIO_IN_ENABLE1_I2SEXT_MCLK
#undef ATH_GPIO_IN_ENABLE2
#undef ATH_GPIO_IN_ENABLE3
#undef ATH_GPIO_IN_ENABLE4
#undef ATH_GPIO_IN_ENABLE4_SLIC_DATA_IN
#undef ATH_GPIO_IN_ENABLE4_SLIC_PCM_FS_IN
#undef ATH_GPIO_IN_ENABLE5
#undef ATH_GPIO_IN_ENABLE6
#undef ATH_GPIO_IN_ENABLE7
#undef ATH_GPIO_IN_ENABLE8
#undef ATH_GPIO_IN_ENABLE9
#undef ATH_GPIO_IN_ETH_SWITCH_LED
#undef ATH_GPIO_INT_ENABLE
#undef ATH_GPIO_INT_MASK
#undef ATH_GPIO_INT_PENDING
#undef ATH_GPIO_INT_POLARITY
#undef ATH_GPIO_INT_TYPE
#undef ATH_GPIO_IRQ_BASE
#undef ATH_GPIO_IRQ_COUNT
#undef ATH_GPIO_IRQn
#undef ATH_GPIO_OE
#undef ATH_GPIO_OE_EN
#undef ATH_GPIO_OUT
#undef ATH_GPIO_OUT_FUNCTION0
#undef ATH_GPIO_OUT_FUNCTION0_ENABLE_GPIO_2
#undef ATH_GPIO_OUT_FUNCTION0_ENABLE_GPIO_3
#undef ATH_GPIO_OUT_FUNCTION1
#undef ATH_GPIO_OUT_FUNCTION1_ENABLE_GPIO_4
#undef ATH_GPIO_OUT_FUNCTION1_ENABLE_GPIO_5
#undef ATH_GPIO_OUT_FUNCTION1_ENABLE_GPIO_6
#undef ATH_GPIO_OUT_FUNCTION1_ENABLE_GPIO_7
#undef ATH_GPIO_OUT_FUNCTION2
#undef ATH_GPIO_OUT_FUNCTION2_ENABLE_GPIO_10
#undef ATH_GPIO_OUT_FUNCTION2_ENABLE_GPIO_11
#undef ATH_GPIO_OUT_FUNCTION2_ENABLE_GPIO_8
#undef ATH_GPIO_OUT_FUNCTION2_ENABLE_GPIO_9
#undef ATH_GPIO_OUT_FUNCTION3
#undef ATH_GPIO_OUT_FUNCTION3_ENABLE_GPIO_12
#undef ATH_GPIO_OUT_FUNCTION3_ENABLE_GPIO_13
#undef ATH_GPIO_OUT_FUNCTION3_ENABLE_GPIO_14
#undef ATH_GPIO_OUT_FUNCTION3_ENABLE_GPIO_15
#undef ATH_GPIO_OUT_FUNCTION4
#undef ATH_GPIO_OUT_FUNCTION5
#undef ATH_GPIO_SET
#undef ATH_HS_UART_BAUD
#undef ATH_HS_UART_CLK
#undef ATH_HS_UART_CS
#undef ATH_HS_UART_INT_EN
#undef ATH_HS_UART_INT_STATUS
#undef ATH_MBOX_DMA_PAUSE
#undef ATH_MBOX_DMA_POLICY
#undef ATH_MBOX_DMA_POLICY_RX_QUANTUM
#undef ATH_MBOX_DMA_POLICY_TX_FIFO_THRESH
#undef ATH_MBOX_DMA_POLICY_TX_QUANTUM
#undef ATH_MBOX_DMA_RESUME
#undef ATH_MBOX_DMA_RX_CONTROL0
#undef ATH_MBOX_DMA_RX_CONTROL1
#undef ATH_MBOX_DMA_RX_DESCRIPTOR_BASE0
#undef ATH_MBOX_DMA_RX_DESCRIPTOR_BASE1
#undef ATH_MBOX_DMA_START
#undef ATH_MBOX_DMA_TX_CONTROL0
#undef ATH_MBOX_DMA_TX_CONTROL1
#undef ATH_MBOX_DMA_TX_DESCRIPTOR_BASE0
#undef ATH_MBOX_DMA_TX_DESCRIPTOR_BASE1
#undef ATH_MBOX_FIFO
#undef ATH_MBOX_FIFO_RESET
#undef ATH_MBOX_FIFO_STATUS
#undef ATH_MBOX_FIFO_TIMEOUT
#undef ATH_MBOX_FRAME
#undef ATH_MBOX_INT_ENABLE
#undef ATH_MBOX_INT_STATUS
#undef ATH_MBOX_RX_DMA_COMPLETE
#undef ATH_MBOX_RX_NOT_FULL
#undef ATH_MBOX_RX_UNDERFLOW
#undef ATH_MBOX_SLIC_DMA_POLICY
#undef ATH_MBOX_SLIC_FIFO_RESET
#undef ATH_MBOX_SLIC_FIFO_STATUS
#undef ATH_MBOX_SLIC_FRAME
#undef ATH_MBOX_SLIC_INT_ENABLE
#undef ATH_MBOX_SLIC_INT_STATUS
#undef ATH_MBOX_TX_DMA_COMPLETE
#undef ATH_MBOX_TX_DMA_EOM_COMPLETE
#undef ATH_MBOX_TX_NOT_EMPTY
#undef ATH_MBOX_TX_OVERFLOW
#undef ATH_MII0_CTRL
#undef ATH_MII1_CTRL
#undef ATH_MISC_INT_MASK
#undef ATH_MISC_INT_STATUS
#undef ATH_MISC_IRQ_BASE
#undef ATH_MISC_IRQ_COUNT
#undef ATH_MISC_IRQ_DMA
#undef ATH_MISC_IRQ_ENET_LINK
#undef ATH_MISC_IRQ_ERROR
#undef ATH_MISC_IRQ_GPIO
#undef ATH_MISC_IRQ_HS_UART
#undef ATH_MISC_IRQ_NAT_AGER
#undef ATH_MISC_IRQ_PERF_COUNTER
#undef ATH_MISC_IRQ_TIMER
#undef ATH_MISC_IRQ_UART
#undef ATH_MISC_IRQ_USB_OHCI
#undef ATH_MISC_IRQ_WATCHDOG
#undef ATH_NAND_FLASH_BASE
#undef ATH_OBSERVATION_ENABLE
#undef ATH_OTP_BASE
#undef ATH_OTP_INTF0_ADDRESS
#undef ATH_OTP_INTF2_ADDRESS
#undef ATH_OTP_INTF3_ADDRESS
#undef ATH_OTP_LDO_CONTROL
#undef ATH_OTP_LDO_STATUS
#undef ATH_OTP_MEM_ADDRESS
#undef ATH_OTP_PGENB_SETUP_HOLD_TIME_ADDRESS
#undef ATH_OTP_SIZE
#undef ATH_OTP_STATUS0_ADDRESS
#undef ATH_OTP_STATUS1_ADDRESS
#undef ATH_PCI_AHB_ERROR
#undef ATH_PCI_AHB_ERROR_ADDRESS
#undef ATH_PCI_CFG_AD
#undef ATH_PCI_CFG_CBE
#undef ATH_PCI_CFG_RDDATA
#undef ATH_PCI_CFG_WRDATA
#undef ATH_PCI_CRP
#undef ATH_PCI_CRP_AD_CBE
#undef ATH_PCI_CRP_RDDATA
#undef ATH_PCI_CRP_WRDATA
#undef ATH_PCI_CTLR_BASE
#undef ATH_PCI_DEV_CFGBASE
#undef ATH_PCIE_EP_ASPM_ENABLE
#undef ATH_PCIE_EP_EN_L0
#undef ATH_PCIE_EP_EN_L1
#undef ATH_PCIE_RC_ASPM_ENABLE
#undef ATH_PCIE_RC_ASPM_SUPPORT
#undef ATH_PCIE_RC_EN_L0
#undef ATH_PCIE_RC_EN_L1
#undef ATH_PCIE_RC_SUPP_L0
#undef ATH_PCIE_RC_SUPP_L1
#undef ATH_PCI_ERROR
#undef ATH_PCI_ERROR_ADDRESS
#undef ATH_PCIE_WMAC_INT_STATUS
#undef ATH_PCI_IDSEL_ADLINE_START
#undef ATH_PCI_INT_A_L
#undef ATH_PCI_INT_B_L
#undef ATH_PCI_INT_C_L
#undef ATH_PCI_INT_MASK
#undef ATH_PCI_INT_STATUS
#undef ATH_PCI_IRQ_BASE
#undef ATH_PCI_LCL_APP
#undef ATH_PCI_LCL_BASE
#undef ATH_PCI_LCL_RESET
#undef ATH_PCI_MEM_BASE
#undef ATH_PCI_WINDOW
#undef ATH_PCI_WINDOW0_OFFSET
#undef ATH_PCI_WINDOW0_VAL
#undef ATH_PCI_WINDOW1_OFFSET
#undef ATH_PCI_WINDOW1_VAL
#undef ATH_PCI_WINDOW2_OFFSET
#undef ATH_PCI_WINDOW2_VAL
#undef ATH_PCI_WINDOW3_OFFSET
#undef ATH_PCI_WINDOW3_VAL
#undef ATH_PCI_WINDOW4_OFFSET
#undef ATH_PCI_WINDOW4_VAL
#undef ATH_PCI_WINDOW5_OFFSET
#undef ATH_PCI_WINDOW5_VAL
#undef ATH_PCI_WINDOW6_OFFSET
#undef ATH_PCI_WINDOW6_VAL
#undef ATH_PCI_WINDOW7_OFFSET
#undef ATH_PCI_WINDOW7_VAL
#undef ATH_PERF0_COUNTER
#undef ath_perf0_ctl
#undef ATH_PERF1_COUNTER
#undef ath_perf1_ctl
#undef ATH_PLL_200_200_100
#undef ATH_PLL_266_266_133
#undef ATH_PLL_266_266_66
#undef ATH_PLL_300_300_150
#undef ATH_PLL_333_333_166
#undef ATH_PLL_400_400_200
#undef ATH_PLL_600_400_150
#undef ATH_PLL_BASE
#undef ATH_PLL_CONFIG
#undef ATH_PLL_USE_REV_ID
#undef ATH_REF_CLK_40
#undef ATHR_EG_ACL_CMD0_AND_ACTION
#undef ATHR_EG_ACL_CMD1234
#undef ATHR_EG_ACL_MEM_CTRL
#undef ATHR_EG_ACL_OPERAND0
#undef ATHR_EG_ACL_OPERAND1
#undef ATHR_EG_ACL_RULE_TABLE0_LOWER
#undef ATHR_EG_ACL_RULE_TABLE0_UPPER
#undef ATHR_EG_ACL_RULE_TABLE1_LOWER
#undef ATHR_EG_ACL_RULE_TABLE1_UPPER
#undef ATHR_EG_ACL_RULE_TABLE2_LOWER
#undef ATHR_EG_ACL_RULE_TABLE2_UPPER
#undef ATHR_EG_ACL_RULE_TABLE3_LOWER
#undef ATHR_EG_ACL_RULE_TABLE3_UPPER
#undef ATHR_EG_ACL_RULE_TABLE_FIELDS
#undef ATHR_EG_ACL_STATUS
#undef ATHR_EGRESS_LUT_FRAG_REG
#undef ATHR_EGRESS_LUT_REG
#undef ATH_RESET
#undef ATH_RESET_BASE
#undef ATH_RESET_CPU_COLD_RESET_MASK
#undef ATH_RESET_CPU_NMI
#undef ATH_RESET_DDR
#undef ATH_RESET_DMA
#undef ATH_RESET_EXTERNAL
#undef ATH_RESET_FULL_CHIP
#undef ATH_RESET_GE0_MAC
#undef ATH_RESET_GE0_MDIO
#undef ATH_RESET_GE0_PHY
#undef ATH_RESET_GE1_MAC
#undef ATH_RESET_GE1_PHY
#undef ATH_RESET_I2S
#undef ATH_RESET_PCI_BUS
#undef ATH_RESET_PCI_CORE
#undef ATH_RESET_PCIE_PHY_SHIFT
#undef ATH_RESET_SLIC
#undef ATH_RESET_STEREO
#undef ATH_RESET_USB_HOST
#undef ATH_RESET_USB_OHCI_DLL
#undef ATH_RESET_USB_PHY
#undef ATH_RESET_USB_PHY_ANALOG
#undef ATH_RESET_USBSUS_OVRIDE
#undef ATH_REV_ID
#undef ATH_REV_ID_MASK
#undef ATH_REV_ID_MASK_MAJOR
#undef ATH_REV_ID_MASK_MINOR
#undef ATHR_IG_ACL_CMD0_AND_ACTION
#undef ATHR_IG_ACL_CMD1234
#undef ATHR_IG_ACL_MEM_CTRL
#undef ATHR_IG_ACL_OPERAND0
#undef ATHR_IG_ACL_OPERAND1
#undef ATHR_IG_ACL_RULE_TABLE0_LOWER
#undef ATHR_IG_ACL_RULE_TABLE0_UPPER
#undef ATHR_IG_ACL_RULE_TABLE1_LOWER
#undef ATHR_IG_ACL_RULE_TABLE1_UPPER
#undef ATHR_IG_ACL_RULE_TABLE2_LOWER
#undef ATHR_IG_ACL_RULE_TABLE2_UPPER
#undef ATHR_IG_ACL_RULE_TABLE3_LOWER
#undef ATHR_IG_ACL_RULE_TABLE3_UPPER
#undef ATHR_IG_ACL_RULE_TABLE_FIELDS
#undef ATHR_IG_ACL_STATUS
#undef ATHR_INGRESS_LUT_FRAG_REG
#undef ATHR_INGRESS_LUT_REG
#undef ATHR_LUTS_AGER_INTR
#undef ATHR_LUTS_AGER_INTR_MASK
#undef ATHR_WAN_IP_ADDR_REG
#undef ATH_SLIC_BASE
#undef ATH_SLIC_CLOCK_CTRL
#undef ATH_SLIC_CLOCK_CTRL_DIV
#undef ATH_SLIC_CNTRL_ENABLE
#undef ATH_SLIC_CNTRL_IRQ_ENABLE
#undef ATH_SLIC_CNTRL_SLOT0_ENABLE
#undef ATH_SLIC_CNTRL_SLOT1_ENABLE
#undef ATH_SLIC_CTRL
#undef ATH_SLIC_CTRL_CLK_EN
#undef ATH_SLIC_CTRL_EN
#undef ATH_SLIC_CTRL_MASTER
#undef ATH_SLIC_INTR
#undef ATH_SLIC_INTR_MASK_0
#undef ATH_SLIC_INTR_MASK_1
#undef ATH_SLIC_INTR_MASK_2
#undef ATH_SLIC_INTR_MASK_3
#undef ATH_SLIC_INTR_MASK_4
#undef ATH_SLIC_INTR_MASK_RESET
#undef ATH_SLIC_INTR_MASK
#undef ATH_SLIC_INTR_STATUS_NO_INTR
#undef ATH_SLIC_INTR_STATUS_UNEXP_FRAME
#undef ATH_SLIC_RX_SLOTS1
#undef ATH_SLIC_RX_SLOTS1_EN
#undef ATH_SLIC_RX_SLOTS2
#undef ATH_SLIC_RX_SLOTS2_EN
#undef ATH_SLIC_SLOT
#undef ATH_SLIC_SLOT_SEL
#undef ATH_SLIC_SWAP
#undef ATH_SLIC_SWAP_RX_DATA
#undef ATH_SLIC_SWAP_TX_DATA
#undef ATH_SLIC_TIMING_CTRL
#undef ATH_SLIC_TIMING_CTRL_DATAOEN_ALWAYS
#undef ATH_SLIC_TIMING_CTRL_FS_POS
#undef ATH_SLIC_TIMING_CTRL_LONG_FS
#undef ATH_SLIC_TIMING_CTRL_LONG_FSCLKS_1BIT
#undef ATH_SLIC_TIMING_CTRL_LONG_FSCLKS_8BIT
#undef ATH_SLIC_TIMING_CTRL_LONG_FSCLKS
#undef ATH_SLIC_TIMING_CTRL_RXDATA_SAMPLE_POS_1_NGEDGE
#undef ATH_SLIC_TIMING_CTRL_RXDATA_SAMPLE_POS_2_NGEDGE
#undef ATH_SLIC_TIMING_CTRL_RXDATA_SAMPLE_POS_EXTEND
#undef ATH_SLIC_TIMING_CTRL_RXDATA_SAMPLE_POS
#undef ATH_SLIC_TIMING_CTRL_TXDATA_FS_SYNC_NXT_NGEDGE
#undef ATH_SLIC_TIMING_CTRL_TXDATA_FS_SYNC_NXT_PSEDGE
#undef ATH_SLIC_TIMING_CTRL_TXDATA_FS_SYNC
#undef ATH_SLIC_TX_SLOTS1
#undef ATH_SLIC_TX_SLOTS1_EN
#undef ATH_SLIC_TX_SLOTS2
#undef ATH_SLIC_TX_SLOTS2_EN
#undef ATH_SPI_BASE
#undef ATH_SPI_CLK_HIGH
#undef ATH_SPI_CLOCK
#undef ATH_SPI_CMD_FAST_READ
#undef ATH_SPI_CMD_PAGE_PROG
#undef ATH_SPI_CMD_RD_STATUS
#undef ATH_SPI_CMD_SECTOR_ERASE
#undef ATH_SPI_CMD_WREN
#undef ATH_SPI_CMD_WRITE_SR
#undef ATH_SPI_CS_DIS
#undef ATH_SPI_CS_ENABLE_0
#undef ATH_SPI_CS_ENABLE_1
#undef ATH_SPI_CS_ENABLE_2
#undef ATH_SPI_D0_HIGH
#undef ATH_SPI_FS
#undef ATH_SPI_RD_STATUS
#undef ATH_SPI_READ
#undef ATH_SPI_SHIFT_CNT
#undef ATH_SPI_SHIFT_DI
#undef ATH_SPI_SHIFT_DO
#undef ATH_SPI_WRITE
#undef ATH_STEREO_BASE
#undef ATH_STEREO_CFG_MASTER_STEREO_FS32_48KHZ
#undef ATH_STEREO_CFG_MASTER_STEREO_FS64_48KHZ
#undef ATH_STEREO_CFG_SLAVE_STEREO_FS32_48KHZ
#undef ATH_STEREO_CFG_SLAVE_STEREO_FS64_48KHZ
#undef ATH_STEREO_CONFIG
#undef ATH_STEREO_CONFIG_DATA_WORD_SIZE
#undef ATH_STEREO_CONFIG_DELAY
#undef ATH_STEREO_CONFIG_ENABLE
#undef ATH_STEREO_CONFIG_I2S_32B_WORD
#undef ATH_STEREO_CONFIG_I2S_MCLK_SEL
#undef ATH_STEREO_CONFIG_MASTER
#undef ATH_STEREO_CONFIG_MIC_WORD_SIZE
#undef ATH_STEREO_CONFIG_MODE
#undef ATH_STEREO_CONFIG_PCM_SWAP
#undef ATH_STEREO_CONFIG_PSEDGE
#undef ATH_STEREO_CONFIG_RESET
#undef ATH_STEREO_CONFIG_SAMPLE_CNT_CLEAR_TYPE
#undef ATH_STEREO_CONFIG_SPDIF_ENABLE
#undef ATH_STEREO_MCLK
#undef ATH_STEREO_MODE_LEFT
#undef ATH_STEREO_MODE_RIGHT
#undef ATH_STEREO_MODE_STEREO
#undef ATH_STEREO_VOLUME
#undef ATH_STEREO_WS_16B
#undef ATH_STEREO_WS_24B
#undef ATH_STEREO_WS_32B
#undef ATH_STEREO_WS_8B
#undef ATH_UART_BASE
#undef ATH_USB_CONFIG
#undef ATH_USB_CONFIG_BASE
#undef ATH_USB_EHCI_BASE
#undef ATH_USB_FLADJ_VAL
#undef ATH_USB_MODE
#undef ATH_USB_OHCI_BASE
#undef ATH_USB_WINDOW
#undef ATH_WATCHDOG_TMR
#undef ATH_WATCHDOG_TMR_CONTROL
#undef ATH_WD_ACT_GP_INTR
#undef ATH_WD_ACT_MASK
#undef ATH_WD_ACT_NMI
#undef ATH_WD_ACT_NONE
#undef ATH_WD_ACT_RESET
#undef ATH_WD_LAST_MASK
#undef ATH_WD_LAST_SHIFT
#undef ATH_WMAC_BASE
#undef ATH_WMAC_LEN
#undef ath_write_pci_window
#undef AUDIO_PLL_CONFIG_ADDRESS
#undef AUDIO_PLL_CONFIG_BYPASS_GET
#undef AUDIO_PLL_CONFIG_BYPASS_LSB
#undef AUDIO_PLL_CONFIG_BYPASS_MASK
#undef AUDIO_PLL_CONFIG_BYPASS_MSB
#undef AUDIO_PLL_CONFIG_BYPASS_RESET
#undef AUDIO_PLL_CONFIG_BYPASS_SET
#undef AUDIO_PLL_CONFIG_EXT_DIV_GET
#undef AUDIO_PLL_CONFIG_EXT_DIV_LSB
#undef AUDIO_PLL_CONFIG_EXT_DIV_MASK
#undef AUDIO_PLL_CONFIG_EXT_DIV_MSB
#undef AUDIO_PLL_CONFIG_EXT_DIV_RESET
#undef AUDIO_PLL_CONFIG_EXT_DIV_SET
#undef AUDIO_PLL_CONFIG_OFFSET
#undef AUDIO_PLL_CONFIG_PLLPWD_GET
#undef AUDIO_PLL_CONFIG_PLLPWD_LSB
#undef AUDIO_PLL_CONFIG_PLLPWD_MASK
#undef AUDIO_PLL_CONFIG_PLLPWD_MSB
#undef AUDIO_PLL_CONFIG_PLLPWD_RESET
#undef AUDIO_PLL_CONFIG_PLLPWD_SET
#undef AUDIO_PLL_CONFIG_POSTPLLDIV_GET
#undef AUDIO_PLL_CONFIG_POSTPLLDIV_LSB
#undef AUDIO_PLL_CONFIG_POSTPLLDIV_MASK
#undef AUDIO_PLL_CONFIG_POSTPLLDIV_MSB
#undef AUDIO_PLL_CONFIG_POSTPLLDIV_RESET
#undef AUDIO_PLL_CONFIG_POSTPLLDIV_SET
#undef AUDIO_PLL_CONFIG_REFDIV_GET
#undef AUDIO_PLL_CONFIG_REFDIV_LSB
#undef AUDIO_PLL_CONFIG_REFDIV_MASK
#undef AUDIO_PLL_CONFIG_REFDIV_MSB
#undef AUDIO_PLL_CONFIG_REFDIV_RESET
#undef AUDIO_PLL_CONFIG_REFDIV_SET
#undef AUDIO_PLL_CONFIG_RESET
#undef AUDIO_PLL_CONFIG_RSTMASK
#undef AUDIO_PLL_CONFIG_SW_MASK
#undef AUDIO_PLL_CONFIG_UPDATING_GET
#undef AUDIO_PLL_CONFIG_UPDATING_LSB
#undef AUDIO_PLL_CONFIG_UPDATING_MASK
#undef AUDIO_PLL_CONFIG_UPDATING_MSB
#undef AUDIO_PLL_CONFIG_UPDATING_RESET
#undef AUDIO_PLL_CONFIG_UPDATING_SET
#undef AUDIO_PLL_MOD_STEP_ADDRESS
#undef AUDIO_PLL_MOD_STEP_FRAC_GET
#undef AUDIO_PLL_MOD_STEP_FRAC_LSB
#undef AUDIO_PLL_MOD_STEP_FRAC_MASK
#undef AUDIO_PLL_MOD_STEP_FRAC_MSB
#undef AUDIO_PLL_MOD_STEP_FRAC_RESET
#undef AUDIO_PLL_MOD_STEP_FRAC_SET
#undef AUDIO_PLL_MOD_STEP_INT_GET
#undef AUDIO_PLL_MOD_STEP_INT_LSB
#undef AUDIO_PLL_MOD_STEP_INT_MASK
#undef AUDIO_PLL_MOD_STEP_INT_MSB
#undef AUDIO_PLL_MOD_STEP_INT_RESET
#undef AUDIO_PLL_MOD_STEP_INT_SET
#undef AUDIO_PLL_MOD_STEP_OFFSET
#undef AUDIO_PLL_MOD_STEP_RESET
#undef AUDIO_PLL_MOD_STEP_RSTMASK
#undef AUDIO_PLL_MOD_STEP_SW_MASK
#undef AUDIO_PLL_MOD_STEP_UPDATE_CNT_GET
#undef AUDIO_PLL_MOD_STEP_UPDATE_CNT_LSB
#undef AUDIO_PLL_MOD_STEP_UPDATE_CNT_MASK
#undef AUDIO_PLL_MOD_STEP_UPDATE_CNT_MSB
#undef AUDIO_PLL_MOD_STEP_UPDATE_CNT_RESET
#undef AUDIO_PLL_MOD_STEP_UPDATE_CNT_SET
#undef AUDIO_PLL_MODULATION_ADDRESS
#undef AUDIO_PLL_MODULATION_OFFSET
#undef AUDIO_PLL_MODULATION_RESET
#undef AUDIO_PLL_MODULATION_RSTMASK
#undef AUDIO_PLL_MODULATION_START_GET
#undef AUDIO_PLL_MODULATION_START_LSB
#undef AUDIO_PLL_MODULATION_START_MASK
#undef AUDIO_PLL_MODULATION_START_MSB
#undef AUDIO_PLL_MODULATION_START_RESET
#undef AUDIO_PLL_MODULATION_START_SET
#undef AUDIO_PLL_MODULATION_SW_MASK
#undef AUDIO_PLL_MODULATION_TGT_DIV_FRAC_GET
#undef AUDIO_PLL_MODULATION_TGT_DIV_FRAC_LSB
#undef AUDIO_PLL_MODULATION_TGT_DIV_FRAC_MASK
#undef AUDIO_PLL_MODULATION_TGT_DIV_FRAC_MSB
#undef AUDIO_PLL_MODULATION_TGT_DIV_FRAC_RESET
#undef AUDIO_PLL_MODULATION_TGT_DIV_FRAC_SET
#undef AUDIO_PLL_MODULATION_TGT_DIV_INT_GET
#undef AUDIO_PLL_MODULATION_TGT_DIV_INT_LSB
#undef AUDIO_PLL_MODULATION_TGT_DIV_INT_MASK
#undef AUDIO_PLL_MODULATION_TGT_DIV_INT_MSB
#undef AUDIO_PLL_MODULATION_TGT_DIV_INT_RESET
#undef AUDIO_PLL_MODULATION_TGT_DIV_INT_SET
#undef BB_PLL_CONFIG_ADDRESS
#undef BB_PLL_CONFIG_NFRAC_GET
#undef BB_PLL_CONFIG_NFRAC_LSB
#undef BB_PLL_CONFIG_NFRAC_MASK
#undef BB_PLL_CONFIG_NFRAC_MSB
#undef BB_PLL_CONFIG_NFRAC_RESET
#undef BB_PLL_CONFIG_NFRAC_SET
#undef BB_PLL_CONFIG_NINT_GET
#undef BB_PLL_CONFIG_NINT_LSB
#undef BB_PLL_CONFIG_NINT_MASK
#undef BB_PLL_CONFIG_NINT_MSB
#undef BB_PLL_CONFIG_NINT_RESET
#undef BB_PLL_CONFIG_NINT_SET
#undef BB_PLL_CONFIG_OFFSET
#undef BB_PLL_CONFIG_PLLPWD_GET
#undef BB_PLL_CONFIG_PLLPWD_LSB
#undef BB_PLL_CONFIG_PLLPWD_MASK
#undef BB_PLL_CONFIG_PLLPWD_MSB
#undef BB_PLL_CONFIG_PLLPWD_RESET
#undef BB_PLL_CONFIG_PLLPWD_SET
#undef BB_PLL_CONFIG_REFDIV_GET
#undef BB_PLL_CONFIG_REFDIV_LSB
#undef BB_PLL_CONFIG_REFDIV_MASK
#undef BB_PLL_CONFIG_REFDIV_MSB
#undef BB_PLL_CONFIG_REFDIV_RESET
#undef BB_PLL_CONFIG_REFDIV_SET
#undef BB_PLL_CONFIG_RESET
#undef BB_PLL_CONFIG_RSTMASK
#undef BB_PLL_CONFIG_SPARE_GET
#undef BB_PLL_CONFIG_SPARE_LSB
#undef BB_PLL_CONFIG_SPARE_MASK
#undef BB_PLL_CONFIG_SPARE_MSB
#undef BB_PLL_CONFIG_SPARE_RESET
#undef BB_PLL_CONFIG_SPARE_SET
#undef BB_PLL_CONFIG_SW_MASK
#undef BB_PLL_CONFIG_UPDATING_GET
#undef BB_PLL_CONFIG_UPDATING_LSB
#undef BB_PLL_CONFIG_UPDATING_MASK
#undef BB_PLL_CONFIG_UPDATING_MSB
#undef BB_PLL_CONFIG_UPDATING_RESET
#undef BB_PLL_CONFIG_UPDATING_SET
#undef CPU_DDR_CLOCK_CONTROL_ADDRESS
#undef CPU_DDR_CLOCK_CONTROL_AHBCLK_FROM_DDRPLL_GET
#undef CPU_DDR_CLOCK_CONTROL_AHBCLK_FROM_DDRPLL_LSB
#undef CPU_DDR_CLOCK_CONTROL_AHBCLK_FROM_DDRPLL_MASK
#undef CPU_DDR_CLOCK_CONTROL_AHBCLK_FROM_DDRPLL_MSB
#undef CPU_DDR_CLOCK_CONTROL_AHBCLK_FROM_DDRPLL_RESET
#undef CPU_DDR_CLOCK_CONTROL_AHBCLK_FROM_DDRPLL_SET
#undef CPU_DDR_CLOCK_CONTROL_AHB_PLL_BYPASS_GET
#undef CPU_DDR_CLOCK_CONTROL_AHB_PLL_BYPASS_LSB
#undef CPU_DDR_CLOCK_CONTROL_AHB_PLL_BYPASS_MASK
#undef CPU_DDR_CLOCK_CONTROL_AHB_PLL_BYPASS_MSB
#undef CPU_DDR_CLOCK_CONTROL_AHB_PLL_BYPASS_RESET
#undef CPU_DDR_CLOCK_CONTROL_AHB_PLL_BYPASS_SET
#undef CPU_DDR_CLOCK_CONTROL_AHB_POST_DIV_GET
#undef CPU_DDR_CLOCK_CONTROL_AHB_POST_DIV_LSB
#undef CPU_DDR_CLOCK_CONTROL_AHB_POST_DIV_MASK
#undef CPU_DDR_CLOCK_CONTROL_AHB_POST_DIV_MSB
#undef CPU_DDR_CLOCK_CONTROL_AHB_POST_DIV_RESET
#undef CPU_DDR_CLOCK_CONTROL_AHB_POST_DIV_SET
#undef CPU_DDR_CLOCK_CONTROL_CLOCK_SWITCH_GET
#undef CPU_DDR_CLOCK_CONTROL_CLOCK_SWITCH_LSB
#undef CPU_DDR_CLOCK_CONTROL_CLOCK_SWITCH_MASK
#undef CPU_DDR_CLOCK_CONTROL_CLOCK_SWITCH_MSB
#undef CPU_DDR_CLOCK_CONTROL_CLOCK_SWITCH_RESET
#undef CPU_DDR_CLOCK_CONTROL_CLOCK_SWITCH_SET
#undef CPU_DDR_CLOCK_CONTROL_CPUCLK_FROM_CPUPLL_GET
#undef CPU_DDR_CLOCK_CONTROL_CPUCLK_FROM_CPUPLL_LSB
#undef CPU_DDR_CLOCK_CONTROL_CPUCLK_FROM_CPUPLL_MASK
#undef CPU_DDR_CLOCK_CONTROL_CPUCLK_FROM_CPUPLL_MSB
#undef CPU_DDR_CLOCK_CONTROL_CPUCLK_FROM_CPUPLL_RESET
#undef CPU_DDR_CLOCK_CONTROL_CPUCLK_FROM_CPUPLL_SET
#undef CPU_DDR_CLOCK_CONTROL_CPU_PLL_BYPASS_GET
#undef CPU_DDR_CLOCK_CONTROL_CPU_PLL_BYPASS_LSB
#undef CPU_DDR_CLOCK_CONTROL_CPU_PLL_BYPASS_MASK
#undef CPU_DDR_CLOCK_CONTROL_CPU_PLL_BYPASS_MSB
#undef CPU_DDR_CLOCK_CONTROL_CPU_PLL_BYPASS_RESET
#undef CPU_DDR_CLOCK_CONTROL_CPU_PLL_BYPASS_SET
#undef CPU_DDR_CLOCK_CONTROL_CPU_POST_DIV_GET
#undef CPU_DDR_CLOCK_CONTROL_CPU_POST_DIV_LSB
#undef CPU_DDR_CLOCK_CONTROL_CPU_POST_DIV_MASK
#undef CPU_DDR_CLOCK_CONTROL_CPU_POST_DIV_MSB
#undef CPU_DDR_CLOCK_CONTROL_CPU_POST_DIV_RESET
#undef CPU_DDR_CLOCK_CONTROL_CPU_POST_DIV_SET
#undef CPU_DDR_CLOCK_CONTROL_CPU_RESET_EN_BP_ASRT_GET
#undef CPU_DDR_CLOCK_CONTROL_CPU_RESET_EN_BP_ASRT_LSB
#undef CPU_DDR_CLOCK_CONTROL_CPU_RESET_EN_BP_ASRT_MASK
#undef CPU_DDR_CLOCK_CONTROL_CPU_RESET_EN_BP_ASRT_MSB
#undef CPU_DDR_CLOCK_CONTROL_CPU_RESET_EN_BP_ASRT_RESET
#undef CPU_DDR_CLOCK_CONTROL_CPU_RESET_EN_BP_ASRT_SET
#undef CPU_DDR_CLOCK_CONTROL_CPU_RESET_EN_BP_DEASSRT_GET
#undef CPU_DDR_CLOCK_CONTROL_CPU_RESET_EN_BP_DEASSRT_LSB
#undef CPU_DDR_CLOCK_CONTROL_CPU_RESET_EN_BP_DEASSRT_MASK
#undef CPU_DDR_CLOCK_CONTROL_CPU_RESET_EN_BP_DEASSRT_MSB
#undef CPU_DDR_CLOCK_CONTROL_CPU_RESET_EN_BP_DEASSRT_RESET
#undef CPU_DDR_CLOCK_CONTROL_CPU_RESET_EN_BP_DEASSRT_SET
#undef CPU_DDR_CLOCK_CONTROL_DDRCLK_FROM_DDRPLL_GET
#undef CPU_DDR_CLOCK_CONTROL_DDRCLK_FROM_DDRPLL_LSB
#undef CPU_DDR_CLOCK_CONTROL_DDRCLK_FROM_DDRPLL_MASK
#undef CPU_DDR_CLOCK_CONTROL_DDRCLK_FROM_DDRPLL_MSB
#undef CPU_DDR_CLOCK_CONTROL_DDRCLK_FROM_DDRPLL_RESET
#undef CPU_DDR_CLOCK_CONTROL_DDRCLK_FROM_DDRPLL_SET
#undef CPU_DDR_CLOCK_CONTROL_DDR_PLL_BYPASS_GET
#undef CPU_DDR_CLOCK_CONTROL_DDR_PLL_BYPASS_LSB
#undef CPU_DDR_CLOCK_CONTROL_DDR_PLL_BYPASS_MASK
#undef CPU_DDR_CLOCK_CONTROL_DDR_PLL_BYPASS_MSB
#undef CPU_DDR_CLOCK_CONTROL_DDR_PLL_BYPASS_RESET
#undef CPU_DDR_CLOCK_CONTROL_DDR_PLL_BYPASS_SET
#undef CPU_DDR_CLOCK_CONTROL_DDR_POST_DIV_GET
#undef CPU_DDR_CLOCK_CONTROL_DDR_POST_DIV_LSB
#undef CPU_DDR_CLOCK_CONTROL_DDR_POST_DIV_MASK
#undef CPU_DDR_CLOCK_CONTROL_DDR_POST_DIV_MSB
#undef CPU_DDR_CLOCK_CONTROL_DDR_POST_DIV_RESET
#undef CPU_DDR_CLOCK_CONTROL_DDR_POST_DIV_SET
#undef CPU_DDR_CLOCK_CONTROL_OFFSET
#undef CPU_DDR_CLOCK_CONTROL_RESET
#undef CPU_DDR_CLOCK_CONTROL_RESET_SWITCH_GET
#undef CPU_DDR_CLOCK_CONTROL_RESET_SWITCH_LSB
#undef CPU_DDR_CLOCK_CONTROL_RESET_SWITCH_MASK
#undef CPU_DDR_CLOCK_CONTROL_RESET_SWITCH_MSB
#undef CPU_DDR_CLOCK_CONTROL_RESET_SWITCH_RESET
#undef CPU_DDR_CLOCK_CONTROL_RESET_SWITCH_SET
#undef CPU_DDR_CLOCK_CONTROL_RSTMASK
#undef CPU_DDR_CLOCK_CONTROL_SPARE_GET
#undef CPU_DDR_CLOCK_CONTROL_SPARE_LSB
#undef CPU_DDR_CLOCK_CONTROL_SPARE_MASK
#undef CPU_DDR_CLOCK_CONTROL_SPARE_MSB
#undef CPU_DDR_CLOCK_CONTROL_SPARE_RESET
#undef CPU_DDR_CLOCK_CONTROL_SPARE_SET
#undef CPU_DDR_CLOCK_CONTROL_SW_MASK
#undef CPU_DPLL2_ADDRESS
#undef CPU_DPLL2_DELTA_GET
#undef CPU_DPLL2_DELTA_LSB
#undef CPU_DPLL2_DELTA_MASK
#undef CPU_DPLL2_DELTA_MSB
#undef CPU_DPLL2_DELTA_RESET
#undef CPU_DPLL2_DELTA_SET
#undef CPU_DPLL2_EN_NEGTRIG_GET
#undef CPU_DPLL2_EN_NEGTRIG_LSB
#undef CPU_DPLL2_EN_NEGTRIG_MASK
#undef CPU_DPLL2_EN_NEGTRIG_MSB
#undef CPU_DPLL2_EN_NEGTRIG_RESET
#undef CPU_DPLL2_EN_NEGTRIG_SET
#undef CPU_DPLL2_KD_GET
#undef CPU_DPLL2_KD_LSB
#undef CPU_DPLL2_KD_MASK
#undef CPU_DPLL2_KD_MSB
#undef CPU_DPLL2_KD_RESET
#undef CPU_DPLL2_KD_SET
#undef CPU_DPLL2_KI_GET
#undef CPU_DPLL2_KI_LSB
#undef CPU_DPLL2_KI_MASK
#undef CPU_DPLL2_KI_MSB
#undef CPU_DPLL2_KI_RESET
#undef CPU_DPLL2_KI_SET
#undef CPU_DPLL2_LOCAL_PLL_GET
#undef CPU_DPLL2_LOCAL_PLL_LSB
#undef CPU_DPLL2_LOCAL_PLL_MASK
#undef CPU_DPLL2_LOCAL_PLL_MSB
#undef CPU_DPLL2_LOCAL_PLL_RESET
#undef CPU_DPLL2_LOCAL_PLL_SET
#undef CPU_DPLL2_OUTDIV_GET
#undef CPU_DPLL2_OUTDIV_LSB
#undef CPU_DPLL2_OUTDIV_MASK
#undef CPU_DPLL2_OUTDIV_MSB
#undef CPU_DPLL2_OUTDIV_RESET
#undef CPU_DPLL2_OUTDIV_SET
#undef CPU_DPLL2_PLL_PWD_GET
#undef CPU_DPLL2_PLL_PWD_LSB
#undef CPU_DPLL2_PLL_PWD_MASK
#undef CPU_DPLL2_PLL_PWD_MSB
#undef CPU_DPLL2_PLL_PWD_RESET
#undef CPU_DPLL2_PLL_PWD_SET
#undef CPU_DPLL2_RANGE_GET
#undef CPU_DPLL2_RANGE_LSB
#undef CPU_DPLL2_RANGE_MASK
#undef CPU_DPLL2_RANGE_MSB
#undef CPU_DPLL2_RANGE_RESET
#undef CPU_DPLL2_RANGE_SET
#undef CPU_DPLL2_SEL_1SDM_GET
#undef CPU_DPLL2_SEL_1SDM_LSB
#undef CPU_DPLL2_SEL_1SDM_MASK
#undef CPU_DPLL2_SEL_1SDM_MSB
#undef CPU_DPLL2_SEL_1SDM_RESET
#undef CPU_DPLL2_SEL_1SDM_SET
#undef CPU_DPLL2_SPARE_GET
#undef CPU_DPLL2_SPARE_LSB
#undef CPU_DPLL2_SPARE_MASK
#undef CPU_DPLL2_SPARE_MSB
#undef CPU_DPLL2_SPARE_RESET
#undef CPU_DPLL2_SPARE_SET
#undef CPU_DPLL_ADDRESS
#undef CPU_DPLL_NFRAC_GET
#undef CPU_DPLL_NFRAC_LSB
#undef CPU_DPLL_NFRAC_MASK
#undef CPU_DPLL_NFRAC_MSB
#undef CPU_DPLL_NFRAC_RESET
#undef CPU_DPLL_NFRAC_SET
#undef CPU_DPLL_NINT_GET
#undef CPU_DPLL_NINT_LSB
#undef CPU_DPLL_NINT_MASK
#undef CPU_DPLL_NINT_MSB
#undef CPU_DPLL_NINT_RESET
#undef CPU_DPLL_NINT_SET
#undef CPU_DPLL_REFDIV_GET
#undef CPU_DPLL_REFDIV_LSB
#undef CPU_DPLL_REFDIV_MASK
#undef CPU_DPLL_REFDIV_MSB
#undef CPU_DPLL_REFDIV_RESET
#undef CPU_DPLL_REFDIV_SET
#undef CPU_PLL_CONFIG_ADDRESS
#undef CPU_PLL_CONFIG_NFRAC_GET
#undef CPU_PLL_CONFIG_NFRAC_LSB
#undef CPU_PLL_CONFIG_NFRAC_MASK
#undef CPU_PLL_CONFIG_NFRAC_MSB
#undef CPU_PLL_CONFIG_NFRAC_RESET
#undef CPU_PLL_CONFIG_NFRAC_SET
#undef CPU_PLL_CONFIG_NINT_GET
#undef CPU_PLL_CONFIG_NINT_LSB
#undef CPU_PLL_CONFIG_NINT_MASK
#undef CPU_PLL_CONFIG_NINT_MSB
#undef CPU_PLL_CONFIG_NINT_RESET
#undef CPU_PLL_CONFIG_NINT_SET
#undef CPU_PLL_CONFIG_OFFSET
#undef CPU_PLL_CONFIG_OUTDIV_GET
#undef CPU_PLL_CONFIG_OUTDIV_LSB
#undef CPU_PLL_CONFIG_OUTDIV_MASK
#undef CPU_PLL_CONFIG_OUTDIV_MSB
#undef CPU_PLL_CONFIG_OUTDIV_RESET
#undef CPU_PLL_CONFIG_OUTDIV_SET
#undef CPU_PLL_CONFIG_PLLPWD_GET
#undef CPU_PLL_CONFIG_PLLPWD_LSB
#undef CPU_PLL_CONFIG_PLLPWD_MASK
#undef CPU_PLL_CONFIG_PLLPWD_MSB
#undef CPU_PLL_CONFIG_PLLPWD_RESET
#undef CPU_PLL_CONFIG_PLLPWD_SET
#undef CPU_PLL_CONFIG_RANGE_GET
#undef CPU_PLL_CONFIG_RANGE_LSB
#undef CPU_PLL_CONFIG_RANGE_MASK
#undef CPU_PLL_CONFIG_RANGE_MSB
#undef CPU_PLL_CONFIG_RANGE_RESET
#undef CPU_PLL_CONFIG_RANGE_SET
#undef CPU_PLL_CONFIG_REFDIV_GET
#undef CPU_PLL_CONFIG_REFDIV_LSB
#undef CPU_PLL_CONFIG_REFDIV_MASK
#undef CPU_PLL_CONFIG_REFDIV_MSB
#undef CPU_PLL_CONFIG_REFDIV_RESET
#undef CPU_PLL_CONFIG_REFDIV_SET
#undef CPU_PLL_CONFIG_RESET
#undef CPU_PLL_CONFIG_RSTMASK
#undef CPU_PLL_CONFIG_SPARE_GET
#undef CPU_PLL_CONFIG_SPARE_LSB
#undef CPU_PLL_CONFIG_SPARE_MASK
#undef CPU_PLL_CONFIG_SPARE_MSB
#undef CPU_PLL_CONFIG_SPARE_RESET
#undef CPU_PLL_CONFIG_SPARE_SET
#undef CPU_PLL_CONFIG_SW_MASK
#undef CPU_PLL_CONFIG_UPDATING_GET
#undef CPU_PLL_CONFIG_UPDATING_LSB
#undef CPU_PLL_CONFIG_UPDATING_MASK
#undef CPU_PLL_CONFIG_UPDATING_MSB
#undef CPU_PLL_CONFIG_UPDATING_RESET
#undef CPU_PLL_CONFIG_UPDATING_SET
#undef CPU_PLL_DITHER_ADDRESS
#undef CPU_PLL_DITHER_DITHER_EN_GET
#undef CPU_PLL_DITHER_DITHER_EN_LSB
#undef CPU_PLL_DITHER_DITHER_EN_MASK
#undef CPU_PLL_DITHER_DITHER_EN_MSB
#undef CPU_PLL_DITHER_DITHER_EN_RESET
#undef CPU_PLL_DITHER_DITHER_EN_SET
#undef CPU_PLL_DITHER_NFRAC_MAX_GET
#undef CPU_PLL_DITHER_NFRAC_MAX_LSB
#undef CPU_PLL_DITHER_NFRAC_MAX_MASK
#undef CPU_PLL_DITHER_NFRAC_MAX_MSB
#undef CPU_PLL_DITHER_NFRAC_MAX_RESET
#undef CPU_PLL_DITHER_NFRAC_MAX_SET
#undef CPU_PLL_DITHER_NFRAC_MIN_GET
#undef CPU_PLL_DITHER_NFRAC_MIN_LSB
#undef CPU_PLL_DITHER_NFRAC_MIN_MASK
#undef CPU_PLL_DITHER_NFRAC_MIN_MSB
#undef CPU_PLL_DITHER_NFRAC_MIN_RESET
#undef CPU_PLL_DITHER_NFRAC_MIN_SET
#undef CPU_PLL_DITHER_NFRAC_STEP_GET
#undef CPU_PLL_DITHER_NFRAC_STEP_LSB
#undef CPU_PLL_DITHER_NFRAC_STEP_MASK
#undef CPU_PLL_DITHER_NFRAC_STEP_MSB
#undef CPU_PLL_DITHER_NFRAC_STEP_RESET
#undef CPU_PLL_DITHER_NFRAC_STEP_SET
#undef CPU_PLL_DITHER_OFFSET
#undef CPU_PLL_DITHER_RESET
#undef CPU_PLL_DITHER_RSTMASK
#undef CPU_PLL_DITHER_SW_MASK
#undef CPU_PLL_DITHER_UPDATE_COUNT_GET
#undef CPU_PLL_DITHER_UPDATE_COUNT_LSB
#undef CPU_PLL_DITHER_UPDATE_COUNT_MASK
#undef CPU_PLL_DITHER_UPDATE_COUNT_MSB
#undef CPU_PLL_DITHER_UPDATE_COUNT_RESET
#undef CPU_PLL_DITHER_UPDATE_COUNT_SET
#undef CPU_SYNC_ADDRESS
#undef CPU_SYNC_LENGTH_GET
#undef CPU_SYNC_LENGTH_LSB
#undef CPU_SYNC_LENGTH_MASK
#undef CPU_SYNC_LENGTH_MSB
#undef CPU_SYNC_LENGTH_RESET
#undef CPU_SYNC_LENGTH_SET
#undef CPU_SYNC_OFFSET
#undef CPU_SYNC_PATTERN_GET
#undef CPU_SYNC_PATTERN_LSB
#undef CPU_SYNC_PATTERN_MASK
#undef CPU_SYNC_PATTERN_MSB
#undef CPU_SYNC_PATTERN_RESET
#undef CPU_SYNC_PATTERN_SET
#undef CPU_SYNC_RESET
#undef CPU_SYNC_RSTMASK
#undef CPU_SYNC_SW_MASK
#undef CURRENT_AUDIO_PLL_MODULATION_ADDRESS
#undef CURRENT_AUDIO_PLL_MODULATION_FRAC_GET
#undef CURRENT_AUDIO_PLL_MODULATION_FRAC_LSB
#undef CURRENT_AUDIO_PLL_MODULATION_FRAC_MASK
#undef CURRENT_AUDIO_PLL_MODULATION_FRAC_MSB
#undef CURRENT_AUDIO_PLL_MODULATION_FRAC_RESET
#undef CURRENT_AUDIO_PLL_MODULATION_FRAC_SET
#undef CURRENT_AUDIO_PLL_MODULATION_INT_GET
#undef CURRENT_AUDIO_PLL_MODULATION_INT_LSB
#undef CURRENT_AUDIO_PLL_MODULATION_INT_MASK
#undef CURRENT_AUDIO_PLL_MODULATION_INT_MSB
#undef CURRENT_AUDIO_PLL_MODULATION_INT_RESET
#undef CURRENT_AUDIO_PLL_MODULATION_INT_SET
#undef CURRENT_AUDIO_PLL_MODULATION_OFFSET
#undef CURRENT_AUDIO_PLL_MODULATION_RESET
#undef CURRENT_AUDIO_PLL_MODULATION_RSTMASK
#undef CURRENT_AUDIO_PLL_MODULATION_SW_MASK
#undef CURRENT_PCIE_PLL_DITHER_ADDRESS
#undef CURRENT_PCIE_PLL_DITHER_FRAC_GET
#undef CURRENT_PCIE_PLL_DITHER_FRAC_LSB
#undef CURRENT_PCIE_PLL_DITHER_FRAC_MASK
#undef CURRENT_PCIE_PLL_DITHER_FRAC_MSB
#undef CURRENT_PCIE_PLL_DITHER_FRAC_RESET
#undef CURRENT_PCIE_PLL_DITHER_FRAC_SET
#undef CURRENT_PCIE_PLL_DITHER_INT_GET
#undef CURRENT_PCIE_PLL_DITHER_INT_LSB
#undef CURRENT_PCIE_PLL_DITHER_INT_MASK
#undef CURRENT_PCIE_PLL_DITHER_INT_MSB
#undef CURRENT_PCIE_PLL_DITHER_INT_RESET
#undef CURRENT_PCIE_PLL_DITHER_INT_SET
#undef CURRENT_PCIE_PLL_DITHER_OFFSET
#undef CURRENT_PCIE_PLL_DITHER_RESET
#undef CURRENT_PCIE_PLL_DITHER_RSTMASK
#undef CURRENT_PCIE_PLL_DITHER_SW_MASK
#undef DDR_DIV_MASK
#undef DDR_DIV_SHIFT
#undef DDR_DPLL2_ADDRESS
#undef DDR_DPLL2_DELTA_GET
#undef DDR_DPLL2_DELTA_LSB
#undef DDR_DPLL2_DELTA_MASK
#undef DDR_DPLL2_DELTA_MSB
#undef DDR_DPLL2_DELTA_RESET
#undef DDR_DPLL2_DELTA_SET
#undef DDR_DPLL2_EN_NEGTRIG_GET
#undef DDR_DPLL2_EN_NEGTRIG_LSB
#undef DDR_DPLL2_EN_NEGTRIG_MASK
#undef DDR_DPLL2_EN_NEGTRIG_MSB
#undef DDR_DPLL2_EN_NEGTRIG_RESET
#undef DDR_DPLL2_EN_NEGTRIG_SET
#undef DDR_DPLL2_KD_GET
#undef DDR_DPLL2_KD_LSB
#undef DDR_DPLL2_KD_MASK
#undef DDR_DPLL2_KD_MSB
#undef DDR_DPLL2_KD_RESET
#undef DDR_DPLL2_KD_SET
#undef DDR_DPLL2_KI_GET
#undef DDR_DPLL2_KI_LSB
#undef DDR_DPLL2_KI_MASK
#undef DDR_DPLL2_KI_MSB
#undef DDR_DPLL2_KI_RESET
#undef DDR_DPLL2_KI_SET
#undef DDR_DPLL2_LOCAL_PLL_GET
#undef DDR_DPLL2_LOCAL_PLL_LSB
#undef DDR_DPLL2_LOCAL_PLL_MASK
#undef DDR_DPLL2_LOCAL_PLL_MSB
#undef DDR_DPLL2_LOCAL_PLL_RESET
#undef DDR_DPLL2_LOCAL_PLL_SET
#undef DDR_DPLL2_OUTDIV_GET
#undef DDR_DPLL2_OUTDIV_LSB
#undef DDR_DPLL2_OUTDIV_MASK
#undef DDR_DPLL2_OUTDIV_MSB
#undef DDR_DPLL2_OUTDIV_RESET
#undef DDR_DPLL2_OUTDIV_SET
#undef DDR_DPLL2_PLL_PWD_GET
#undef DDR_DPLL2_PLL_PWD_LSB
#undef DDR_DPLL2_PLL_PWD_MASK
#undef DDR_DPLL2_PLL_PWD_MSB
#undef DDR_DPLL2_PLL_PWD_RESET
#undef DDR_DPLL2_PLL_PWD_SET
#undef DDR_DPLL2_RANGE_GET
#undef DDR_DPLL2_RANGE_LSB
#undef DDR_DPLL2_RANGE_MASK
#undef DDR_DPLL2_RANGE_MSB
#undef DDR_DPLL2_RANGE_RESET
#undef DDR_DPLL2_RANGE_SET
#undef DDR_DPLL2_SEL_1SDM_GET
#undef DDR_DPLL2_SEL_1SDM_LSB
#undef DDR_DPLL2_SEL_1SDM_MASK
#undef DDR_DPLL2_SEL_1SDM_MSB
#undef DDR_DPLL2_SEL_1SDM_RESET
#undef DDR_DPLL2_SEL_1SDM_SET
#undef DDR_DPLL2_SPARE_GET
#undef DDR_DPLL2_SPARE_LSB
#undef DDR_DPLL2_SPARE_MASK
#undef DDR_DPLL2_SPARE_MSB
#undef DDR_DPLL2_SPARE_RESET
#undef DDR_DPLL2_SPARE_SET
#undef DDR_DPLL_ADDRESS
#undef DDR_DPLL_NFRAC_GET
#undef DDR_DPLL_NFRAC_LSB
#undef DDR_DPLL_NFRAC_MASK
#undef DDR_DPLL_NFRAC_MSB
#undef DDR_DPLL_NFRAC_RESET
#undef DDR_DPLL_NFRAC_SET
#undef DDR_DPLL_NINT_GET
#undef DDR_DPLL_NINT_LSB
#undef DDR_DPLL_NINT_MASK
#undef DDR_DPLL_NINT_MSB
#undef DDR_DPLL_NINT_RESET
#undef DDR_DPLL_NINT_SET
#undef DDR_DPLL_REFDIV_GET
#undef DDR_DPLL_REFDIV_LSB
#undef DDR_DPLL_REFDIV_MASK
#undef DDR_DPLL_REFDIV_MSB
#undef DDR_DPLL_REFDIV_RESET
#undef DDR_DPLL_REFDIV_SET
#undef DDR_PLL_CONFIG_ADDRESS
#undef DDR_PLL_CONFIG_NFRAC_GET
#undef DDR_PLL_CONFIG_NFRAC_LSB
#undef DDR_PLL_CONFIG_NFRAC_MASK
#undef DDR_PLL_CONFIG_NFRAC_MSB
#undef DDR_PLL_CONFIG_NFRAC_RESET
#undef DDR_PLL_CONFIG_NFRAC_SET
#undef DDR_PLL_CONFIG_NINT_GET
#undef DDR_PLL_CONFIG_NINT_LSB
#undef DDR_PLL_CONFIG_NINT_MASK
#undef DDR_PLL_CONFIG_NINT_MSB
#undef DDR_PLL_CONFIG_NINT_RESET
#undef DDR_PLL_CONFIG_NINT_SET
#undef DDR_PLL_CONFIG_OFFSET
#undef DDR_PLL_CONFIG_OUTDIV_GET
#undef DDR_PLL_CONFIG_OUTDIV_LSB
#undef DDR_PLL_CONFIG_OUTDIV_MASK
#undef DDR_PLL_CONFIG_OUTDIV_MSB
#undef DDR_PLL_CONFIG_OUTDIV_RESET
#undef DDR_PLL_CONFIG_OUTDIV_SET
#undef DDR_PLL_CONFIG_PLLPWD_GET
#undef DDR_PLL_CONFIG_PLLPWD_LSB
#undef DDR_PLL_CONFIG_PLLPWD_MASK
#undef DDR_PLL_CONFIG_PLLPWD_MSB
#undef DDR_PLL_CONFIG_PLLPWD_RESET
#undef DDR_PLL_CONFIG_PLLPWD_SET
#undef DDR_PLL_CONFIG_RANGE_GET
#undef DDR_PLL_CONFIG_RANGE_LSB
#undef DDR_PLL_CONFIG_RANGE_MASK
#undef DDR_PLL_CONFIG_RANGE_MSB
#undef DDR_PLL_CONFIG_RANGE_RESET
#undef DDR_PLL_CONFIG_RANGE_SET
#undef DDR_PLL_CONFIG_REFDIV_GET
#undef DDR_PLL_CONFIG_REFDIV_LSB
#undef DDR_PLL_CONFIG_REFDIV_MASK
#undef DDR_PLL_CONFIG_REFDIV_MSB
#undef DDR_PLL_CONFIG_REFDIV_RESET
#undef DDR_PLL_CONFIG_REFDIV_SET
#undef DDR_PLL_CONFIG_RESET
#undef DDR_PLL_CONFIG_RSTMASK
#undef DDR_PLL_CONFIG_SPARE_GET
#undef DDR_PLL_CONFIG_SPARE_LSB
#undef DDR_PLL_CONFIG_SPARE_MASK
#undef DDR_PLL_CONFIG_SPARE_MSB
#undef DDR_PLL_CONFIG_SPARE_RESET
#undef DDR_PLL_CONFIG_SPARE_SET
#undef DDR_PLL_CONFIG_SW_MASK
#undef DDR_PLL_CONFIG_UPDATING_GET
#undef DDR_PLL_CONFIG_UPDATING_LSB
#undef DDR_PLL_CONFIG_UPDATING_MASK
#undef DDR_PLL_CONFIG_UPDATING_MSB
#undef DDR_PLL_CONFIG_UPDATING_RESET
#undef DDR_PLL_CONFIG_UPDATING_SET
#undef DDR_PLL_DITHER_ADDRESS
#undef DDR_PLL_DITHER_DITHER_EN_GET
#undef DDR_PLL_DITHER_DITHER_EN_LSB
#undef DDR_PLL_DITHER_DITHER_EN_MASK
#undef DDR_PLL_DITHER_DITHER_EN_MSB
#undef DDR_PLL_DITHER_DITHER_EN_RESET
#undef DDR_PLL_DITHER_DITHER_EN_SET
#undef DDR_PLL_DITHER_NFRAC_MAX_GET
#undef DDR_PLL_DITHER_NFRAC_MAX_LSB
#undef DDR_PLL_DITHER_NFRAC_MAX_MASK
#undef DDR_PLL_DITHER_NFRAC_MAX_MSB
#undef DDR_PLL_DITHER_NFRAC_MAX_RESET
#undef DDR_PLL_DITHER_NFRAC_MAX_SET
#undef DDR_PLL_DITHER_NFRAC_MIN_GET
#undef DDR_PLL_DITHER_NFRAC_MIN_LSB
#undef DDR_PLL_DITHER_NFRAC_MIN_MASK
#undef DDR_PLL_DITHER_NFRAC_MIN_MSB
#undef DDR_PLL_DITHER_NFRAC_MIN_RESET
#undef DDR_PLL_DITHER_NFRAC_MIN_SET
#undef DDR_PLL_DITHER_NFRAC_STEP_GET
#undef DDR_PLL_DITHER_NFRAC_STEP_LSB
#undef DDR_PLL_DITHER_NFRAC_STEP_MASK
#undef DDR_PLL_DITHER_NFRAC_STEP_MSB
#undef DDR_PLL_DITHER_NFRAC_STEP_RESET
#undef DDR_PLL_DITHER_NFRAC_STEP_SET
#undef DDR_PLL_DITHER_OFFSET
#undef DDR_PLL_DITHER_RESET
#undef DDR_PLL_DITHER_RSTMASK
#undef DDR_PLL_DITHER_SW_MASK
#undef DDR_PLL_DITHER_UPDATE_COUNT_GET
#undef DDR_PLL_DITHER_UPDATE_COUNT_LSB
#undef DDR_PLL_DITHER_UPDATE_COUNT_MASK
#undef DDR_PLL_DITHER_UPDATE_COUNT_MSB
#undef DDR_PLL_DITHER_UPDATE_COUNT_RESET
#undef DDR_PLL_DITHER_UPDATE_COUNT_SET
#undef define
#undef ETH_DST_MAC_ADDR_DW0
#undef ETH_DST_MAC_ADDR_DW1
#undef ETH_EG_AGER_FIFO_REG
#undef ETH_EG_NAT_CNTR
#undef ETH_EG_NAT_DBG
#undef ETH_EG_NAT_STATUS
#undef ETH_IG_AGER_FIFO_REG
#undef ETH_IG_NAT_CNTR
#undef ETH_IG_NAT_DBG
#undef ETH_IG_NAT_STATUS
#undef ETH_LCL_MAC_ADDR_DW0
#undef ETH_LCL_MAC_ADDR_DW1
#undef ETH_XMII_ADDRESS
#undef ETH_XMII_GIGE_GET
#undef ETH_XMII_GIGE_LSB
#undef ETH_XMII_GIGE_MASK
#undef ETH_XMII_GIGE_MSB
#undef ETH_XMII_GIGE_QUAD_GET
#undef ETH_XMII_GIGE_QUAD_LSB
#undef ETH_XMII_GIGE_QUAD_MASK
#undef ETH_XMII_GIGE_QUAD_MSB
#undef ETH_XMII_GIGE_QUAD_RESET
#undef ETH_XMII_GIGE_QUAD_SET
#undef ETH_XMII_GIGE_RESET
#undef ETH_XMII_GIGE_SET
#undef ETH_XMII_OFFSET
#undef ETH_XMII_OFFSET_COUNT_GET
#undef ETH_XMII_OFFSET_COUNT_LSB
#undef ETH_XMII_OFFSET_COUNT_MASK
#undef ETH_XMII_OFFSET_COUNT_MSB
#undef ETH_XMII_OFFSET_COUNT_RESET
#undef ETH_XMII_OFFSET_COUNT_SET
#undef ETH_XMII_OFFSET_PHASE_GET
#undef ETH_XMII_OFFSET_PHASE_LSB
#undef ETH_XMII_OFFSET_PHASE_MASK
#undef ETH_XMII_OFFSET_PHASE_MSB
#undef ETH_XMII_OFFSET_PHASE_RESET
#undef ETH_XMII_OFFSET_PHASE_SET
#undef ETH_XMII_PHASE0_COUNT_GET
#undef ETH_XMII_PHASE0_COUNT_LSB
#undef ETH_XMII_PHASE0_COUNT_MASK
#undef ETH_XMII_PHASE0_COUNT_MSB
#undef ETH_XMII_PHASE0_COUNT_RESET
#undef ETH_XMII_PHASE0_COUNT_SET
#undef ETH_XMII_PHASE1_COUNT_GET
#undef ETH_XMII_PHASE1_COUNT_LSB
#undef ETH_XMII_PHASE1_COUNT_MASK
#undef ETH_XMII_PHASE1_COUNT_MSB
#undef ETH_XMII_PHASE1_COUNT_RESET
#undef ETH_XMII_PHASE1_COUNT_SET
#undef ETH_XMII_RESET
#undef ETH_XMII_RSTMASK
#undef ETH_XMII_RX_DELAY_GET
#undef ETH_XMII_RX_DELAY_LSB
#undef ETH_XMII_RX_DELAY_MASK
#undef ETH_XMII_RX_DELAY_MSB
#undef ETH_XMII_RX_DELAY_RESET
#undef ETH_XMII_RX_DELAY_SET
#undef ETH_XMII_SW_MASK
#undef ETH_XMII_TX_DELAY_GET
#undef ETH_XMII_TX_DELAY_LSB
#undef ETH_XMII_TX_DELAY_MASK
#undef ETH_XMII_TX_DELAY_MSB
#undef ETH_XMII_TX_DELAY_RESET
#undef ETH_XMII_TX_DELAY_SET
#undef ETH_XMII_TX_INVERT_GET
#undef ETH_XMII_TX_INVERT_LSB
#undef ETH_XMII_TX_INVERT_MASK
#undef ETH_XMII_TX_INVERT_MSB
#undef ETH_XMII_TX_INVERT_RESET
#undef ETH_XMII_TX_INVERT_SET
#undef GPIO_OUT_FUNCTION2_ADDRESS
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_10_GET
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_10_LSB
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_10_MASK
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_10_MSB
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_10_RESET
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_10_SET
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_11_GET
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_11_LSB
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_11_MASK
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_11_MSB
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_11_RESET
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_11_SET
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_8_GET
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_8_LSB
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_8_MASK
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_8_MSB
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_8_RESET
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_8_SET
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_9_GET
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_9_LSB
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_9_MASK
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_9_MSB
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_9_RESET
#undef GPIO_OUT_FUNCTION2_ENABLE_GPIO_9_SET
#undef GPIO_OUT_FUNCTION2_OFFSET
#undef GPIO_OUT_FUNCTION2_RESET
#undef GPIO_OUT_FUNCTION2_RSTMASK
#undef GPIO_OUT_FUNCTION2_SW_MASK
#undef GPIO_OUT_FUNCTION3_ADDRESS
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_12_GET
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_12_LSB
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_12_MASK
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_12_MSB
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_12_RESET
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_12_SET
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_13_GET
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_13_LSB
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_13_MASK
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_13_MSB
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_13_RESET
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_13_SET
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_14_GET
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_14_LSB
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_14_MASK
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_14_MSB
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_14_RESET
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_14_SET
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_15_GET
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_15_LSB
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_15_MASK
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_15_MSB
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_15_RESET
#undef GPIO_OUT_FUNCTION3_ENABLE_GPIO_15_SET
#undef GPIO_OUT_FUNCTION3_OFFSET
#undef GPIO_OUT_FUNCTION3_RESET
#undef GPIO_OUT_FUNCTION3_RSTMASK
#undef GPIO_OUT_FUNCTION3_SW_MASK
#undef is_ar9341
#undef is_ar9341_10
#undef is_ar9341_11
#undef is_ar9342
...
#undef is_ar934x_11
#undef is_wasp
#undef LDO_POWER_CONTROL_ADDRESS
#undef LDO_POWER_CONTROL_CPU_REFSEL_GET
#undef LDO_POWER_CONTROL_CPU_REFSEL_LSB
#undef LDO_POWER_CONTROL_CPU_REFSEL_MASK
#undef LDO_POWER_CONTROL_CPU_REFSEL_MSB
#undef LDO_POWER_CONTROL_CPU_REFSEL_RESET
#undef LDO_POWER_CONTROL_CPU_REFSEL_SET
#undef LDO_POWER_CONTROL_OFFSET
#undef LDO_POWER_CONTROL_PKG_SEL_GET
#undef LDO_POWER_CONTROL_PKG_SEL_LSB
#undef LDO_POWER_CONTROL_PKG_SEL_MASK
#undef LDO_POWER_CONTROL_PKG_SEL_MSB
#undef LDO_POWER_CONTROL_PKG_SEL_RESET
#undef LDO_POWER_CONTROL_PKG_SEL_SET
#undef LDO_POWER_CONTROL_PWDLDO_CPU_GET
#undef LDO_POWER_CONTROL_PWDLDO_CPU_LSB
#undef LDO_POWER_CONTROL_PWDLDO_CPU_MASK
#undef LDO_POWER_CONTROL_PWDLDO_CPU_MSB
#undef LDO_POWER_CONTROL_PWDLDO_CPU_RESET
#undef LDO_POWER_CONTROL_PWDLDO_CPU_SET
#undef LDO_POWER_CONTROL_PWDLDO_DDR_GET
#undef LDO_POWER_CONTROL_PWDLDO_DDR_LSB
#undef LDO_POWER_CONTROL_PWDLDO_DDR_MASK
#undef LDO_POWER_CONTROL_PWDLDO_DDR_MSB
#undef LDO_POWER_CONTROL_PWDLDO_DDR_RESET
#undef LDO_POWER_CONTROL_PWDLDO_DDR_SET
#undef LDO_POWER_CONTROL_RESET
#undef LDO_POWER_CONTROL_RSTMASK
#undef LDO_POWER_CONTROL_SELECT_DDR1_GET
#undef LDO_POWER_CONTROL_SELECT_DDR1_LSB
#undef LDO_POWER_CONTROL_SELECT_DDR1_MASK
#undef LDO_POWER_CONTROL_SELECT_DDR1_MSB
#undef LDO_POWER_CONTROL_SELECT_DDR1_RESET
#undef LDO_POWER_CONTROL_SELECT_DDR1_SET
#undef LDO_POWER_CONTROL_SW_MASK
#undef MIMR_DMA
#undef MIMR_ENET_LINK
#undef MIMR_ERROR
#undef MIMR_GPIO
#undef MIMR_HS_UART
#undef MIMR_NAT_AGER
#undef MIMR_OHCI_USB
#undef MIMR_PERF_COUNTER
#undef MIMR_TIMER
#undef MIMR_UART
#undef MIMR_WATCHDOG
#undef MISR_DMA
...
#undef MISR_GPIO
#undef MISR_OHCI_USB
#undef MISR_PERF_COUNTER
#undef MISR_TIMER
#undef MISR_UART
#undef MISR_WATCHDOG
#undef OTP_CSB_ADDR_LOAD_SETUP_HOLD_ADDRESS
#undef OTP_CSB_ADDR_LOAD_SETUP_HOLD_DELAY_GET
#undef OTP_CSB_ADDR_LOAD_SETUP_HOLD_DELAY_LSB
#undef OTP_CSB_ADDR_LOAD_SETUP_HOLD_DELAY_MASK
#undef OTP_CSB_ADDR_LOAD_SETUP_HOLD_DELAY_MSB
#undef OTP_CSB_ADDR_LOAD_SETUP_HOLD_DELAY_SET
#undef OTP_CSB_ADDR_LOAD_SETUP_HOLD_OFFSET
#undef OTP_CSB_ADDR_LOAD_SETUP_HOLD_RESET
#undef OTP_CSB_ADDR_LOAD_SETUP_HOLD_RSTMASK
#undef OTP_CSB_ADDR_LOAD_SETUP_HOLD_SW_MASK
#undef OTP_INTF0_ADDRESS
#undef OTP_INTF0_EFUSE_WR_ENABLE_REG_V_GET
#undef OTP_INTF0_EFUSE_WR_ENABLE_REG_V_LSB
#undef OTP_INTF0_EFUSE_WR_ENABLE_REG_V_MASK
#undef OTP_INTF0_EFUSE_WR_ENABLE_REG_V_MSB
#undef OTP_INTF0_EFUSE_WR_ENABLE_REG_V_SET
#undef OTP_INTF0_OFFSET
#undef OTP_INTF0_RESET
#undef OTP_INTF0_RSTMASK
#undef OTP_INTF0_SW_MASK
#undef OTP_INTF1_ADDRESS
#undef OTP_INTF1_BITMASK_WR_REG_V_GET
#undef OTP_INTF1_BITMASK_WR_REG_V_LSB
#undef OTP_INTF1_BITMASK_WR_REG_V_MASK
#undef OTP_INTF1_BITMASK_WR_REG_V_MSB
#undef OTP_INTF1_BITMASK_WR_REG_V_SET
#undef OTP_INTF1_OFFSET
#undef OTP_INTF1_RESET
#undef OTP_INTF1_RSTMASK
#undef OTP_INTF1_SW_MASK
#undef OTP_INTF2_ADDRESS
#undef OTP_INTF2_OFFSET
#undef OTP_INTF2_PG_STROBE_PW_REG_V_GET
#undef OTP_INTF2_PG_STROBE_PW_REG_V_LSB
#undef OTP_INTF2_PG_STROBE_PW_REG_V_MASK
#undef OTP_INTF2_PG_STROBE_PW_REG_V_MSB
#undef OTP_INTF2_PG_STROBE_PW_REG_V_SET
#undef OTP_INTF2_RESET
#undef OTP_INTF2_RSTMASK
#undef OTP_INTF2_SW_MASK
#undef OTP_INTF3_ADDRESS
#undef OTP_INTF3_OFFSET
#undef OTP_INTF3_RD_STROBE_PW_REG_V_GET
#undef OTP_INTF3_RD_STROBE_PW_REG_V_LSB
#undef OTP_INTF3_RD_STROBE_PW_REG_V_MASK
#undef OTP_INTF3_RD_STROBE_PW_REG_V_MSB
#undef OTP_INTF3_RD_STROBE_PW_REG_V_SET
#undef OTP_INTF3_RESET
#undef OTP_INTF3_RSTMASK
#undef OTP_INTF3_SW_MASK
#undef OTP_INTF4_ADDRESS
#undef OTP_INTF4_OFFSET
#undef OTP_INTF4_RESET
#undef OTP_INTF4_RSTMASK
#undef OTP_INTF4_SW_MASK
#undef OTP_INTF4_VDDQ_SETTLE_TIME_REG_V_GET
#undef OTP_INTF4_VDDQ_SETTLE_TIME_REG_V_LSB
#undef OTP_INTF4_VDDQ_SETTLE_TIME_REG_V_MASK
#undef OTP_INTF4_VDDQ_SETTLE_TIME_REG_V_MSB
#undef OTP_INTF4_VDDQ_SETTLE_TIME_REG_V_SET
#undef OTP_INTF5_ADDRESS
#undef OTP_INTF5_EFUSE_INT_ENABLE_REG_V_GET
#undef OTP_INTF5_EFUSE_INT_ENABLE_REG_V_LSB
#undef OTP_INTF5_EFUSE_INT_ENABLE_REG_V_MASK
#undef OTP_INTF5_EFUSE_INT_ENABLE_REG_V_MSB
#undef OTP_INTF5_EFUSE_INT_ENABLE_REG_V_SET
#undef OTP_INTF5_OFFSET
#undef OTP_INTF5_RESET
#undef OTP_INTF5_RSTMASK
#undef OTP_INTF5_SW_MASK
#undef OTP_INTF6_ADDRESS
#undef OTP_INTF6_BACK_TO_BACK_ACCESS_DELAY_GET
#undef OTP_INTF6_BACK_TO_BACK_ACCESS_DELAY_LSB
#undef OTP_INTF6_BACK_TO_BACK_ACCESS_DELAY_MASK
#undef OTP_INTF6_BACK_TO_BACK_ACCESS_DELAY_MSB
#undef OTP_INTF6_BACK_TO_BACK_ACCESS_DELAY_SET
#undef OTP_INTF6_OFFSET
#undef OTP_INTF6_RESET
#undef OTP_INTF6_RSTMASK
#undef OTP_INTF6_SW_MASK
#undef OTP_LDO_CONTROL_ADDRESS
#undef OTP_LDO_CONTROL_ENABLE_GET
#undef OTP_LDO_CONTROL_ENABLE_LSB
#undef OTP_LDO_CONTROL_ENABLE_MASK
#undef OTP_LDO_CONTROL_ENABLE_MSB
#undef OTP_LDO_CONTROL_ENABLE_SET
#undef OTP_LDO_CONTROL_OFFSET
#undef OTP_LDO_CONTROL_RESET
#undef OTP_LDO_CONTROL_RSTMASK
#undef OTP_LDO_CONTROL_SW_MASK
#undef OTP_LDO_POWER_GOOD_ADDRESS
#undef OTP_LDO_POWER_GOOD_DELAY_GET
#undef OTP_LDO_POWER_GOOD_DELAY_LSB
#undef OTP_LDO_POWER_GOOD_DELAY_MASK
#undef OTP_LDO_POWER_GOOD_DELAY_MSB
#undef OTP_LDO_POWER_GOOD_DELAY_SET
#undef OTP_LDO_POWER_GOOD_OFFSET
#undef OTP_LDO_POWER_GOOD_RESET
#undef OTP_LDO_POWER_GOOD_RSTMASK
#undef OTP_LDO_POWER_GOOD_SW_MASK
#undef OTP_LDO_STATUS_ADDRESS
#undef OTP_LDO_STATUS_OFFSET
#undef OTP_LDO_STATUS_POWER_ON_GET
#undef OTP_LDO_STATUS_POWER_ON_LSB
#undef OTP_LDO_STATUS_POWER_ON_MASK
#undef OTP_LDO_STATUS_POWER_ON_MSB
#undef OTP_LDO_STATUS_POWER_ON_SET
#undef OTP_LDO_STATUS_RESET
#undef OTP_LDO_STATUS_RSTMASK
#undef OTP_LDO_STATUS_SW_MASK
#undef OTP_MEM_0_ADDRESS
#undef OTP_MEM_0_OFFSET
#undef OTP_MEM_0_OTP_MEM_GET
#undef OTP_MEM_0_OTP_MEM_LSB
#undef OTP_MEM_0_OTP_MEM_MASK
#undef OTP_MEM_0_OTP_MEM_MSB
#undef OTP_MEM_0_OTP_MEM_SET
#undef OTP_MEM_0_RESET
#undef OTP_MEM_0_RSTMASK
#undef OTP_MEM_0_SW_MASK
#undef OTP_MEM_ADDRESS
#undef OTP_MEM_OFFSET
#undef OTP_PGENB_SETUP_HOLD_TIME_ADDRESS
#undef OTP_PGENB_SETUP_HOLD_TIME_DELAY_GET
#undef OTP_PGENB_SETUP_HOLD_TIME_DELAY_LSB
#undef OTP_PGENB_SETUP_HOLD_TIME_DELAY_MASK
#undef OTP_PGENB_SETUP_HOLD_TIME_DELAY_MSB
#undef OTP_PGENB_SETUP_HOLD_TIME_DELAY_SET
#undef OTP_PGENB_SETUP_HOLD_TIME_OFFSET
#undef OTP_PGENB_SETUP_HOLD_TIME_RESET
#undef OTP_PGENB_SETUP_HOLD_TIME_RSTMASK
#undef OTP_PGENB_SETUP_HOLD_TIME_SW_MASK
#undef OTP_STATUS0_ADDRESS
#undef OTP_STATUS0_EFUSE_ACCESS_BUSY_GET
#undef OTP_STATUS0_EFUSE_ACCESS_BUSY_LSB
#undef OTP_STATUS0_EFUSE_ACCESS_BUSY_MASK
#undef OTP_STATUS0_EFUSE_ACCESS_BUSY_MSB
#undef OTP_STATUS0_EFUSE_ACCESS_BUSY_SET
#undef OTP_STATUS0_EFUSE_READ_DATA_VALID_GET
#undef OTP_STATUS0_EFUSE_READ_DATA_VALID_LSB
#undef OTP_STATUS0_EFUSE_READ_DATA_VALID_MASK
#undef OTP_STATUS0_EFUSE_READ_DATA_VALID_MSB
#undef OTP_STATUS0_EFUSE_READ_DATA_VALID_SET
#undef OTP_STATUS0_OFFSET
#undef OTP_STATUS0_OTP_SM_BUSY_GET
#undef OTP_STATUS0_OTP_SM_BUSY_LSB
#undef OTP_STATUS0_OTP_SM_BUSY_MASK
#undef OTP_STATUS0_OTP_SM_BUSY_MSB
#undef OTP_STATUS0_OTP_SM_BUSY_SET
#undef OTP_STATUS0_RESET
#undef OTP_STATUS0_RSTMASK
#undef OTP_STATUS0_SW_MASK
#undef OTP_STATUS1_ADDRESS
#undef OTP_STATUS1_EFUSE_READ_DATA_GET
#undef OTP_STATUS1_EFUSE_READ_DATA_LSB
#undef OTP_STATUS1_EFUSE_READ_DATA_MASK
#undef OTP_STATUS1_EFUSE_READ_DATA_MSB
#undef OTP_STATUS1_EFUSE_READ_DATA_SET
#undef OTP_STATUS1_OFFSET
#undef OTP_STATUS1_RESET
#undef OTP_STATUS1_RSTMASK
#undef OTP_STATUS1_SW_MASK
#undef OTP_STROBE_PULSE_INTERVAL_ADDRESS
#undef OTP_STROBE_PULSE_INTERVAL_DELAY_GET
#undef OTP_STROBE_PULSE_INTERVAL_DELAY_LSB
#undef OTP_STROBE_PULSE_INTERVAL_DELAY_MASK
#undef OTP_STROBE_PULSE_INTERVAL_DELAY_MSB
#undef OTP_STROBE_PULSE_INTERVAL_DELAY_SET
#undef OTP_STROBE_PULSE_INTERVAL_OFFSET
#undef OTP_STROBE_PULSE_INTERVAL_RESET
#undef OTP_STROBE_PULSE_INTERVAL_RSTMASK
#undef OTP_STROBE_PULSE_INTERVAL_SW_MASK
#undef OTP_VDDQ_HOLD_TIME_ADDRESS
#undef OTP_VDDQ_HOLD_TIME_DELAY_GET
#undef OTP_VDDQ_HOLD_TIME_DELAY_LSB
#undef OTP_VDDQ_HOLD_TIME_DELAY_MASK
#undef OTP_VDDQ_HOLD_TIME_DELAY_MSB
#undef OTP_VDDQ_HOLD_TIME_DELAY_SET
#undef OTP_VDDQ_HOLD_TIME_OFFSET
#undef OTP_VDDQ_HOLD_TIME_RESET
#undef OTP_VDDQ_HOLD_TIME_RSTMASK
#undef OTP_VDDQ_HOLD_TIME_SW_MASK
#undef PCIE_PLL_CONFIG_ADDRESS
#undef PCIE_PLL_CONFIG_BYPASS_GET
#undef PCIE_PLL_CONFIG_BYPASS_LSB
#undef PCIE_PLL_CONFIG_BYPASS_MASK
#undef PCIE_PLL_CONFIG_BYPASS_MSB
#undef PCIE_PLL_CONFIG_BYPASS_RESET
#undef PCIE_PLL_CONFIG_BYPASS_SET
#undef PCIE_PLL_CONFIG_OFFSET
#undef PCIE_PLL_CONFIG_PLLPWD_GET
#undef PCIE_PLL_CONFIG_PLLPWD_LSB
#undef PCIE_PLL_CONFIG_PLLPWD_MASK
#undef PCIE_PLL_CONFIG_PLLPWD_MSB
#undef PCIE_PLL_CONFIG_PLLPWD_RESET
#undef PCIE_PLL_CONFIG_PLLPWD_SET
#undef PCIE_PLL_CONFIG_REFDIV_GET
#undef PCIE_PLL_CONFIG_REFDIV_LSB
#undef PCIE_PLL_CONFIG_REFDIV_MASK
#undef PCIE_PLL_CONFIG_REFDIV_MSB
#undef PCIE_PLL_CONFIG_REFDIV_RESET
#undef PCIE_PLL_CONFIG_REFDIV_SET
#undef PCIE_PLL_CONFIG_RESET
#undef PCIE_PLL_CONFIG_RSTMASK
#undef PCIE_PLL_CONFIG_SW_MASK
#undef PCIE_PLL_CONFIG_UPDATING_GET
#undef PCIE_PLL_CONFIG_UPDATING_LSB
#undef PCIE_PLL_CONFIG_UPDATING_MASK
#undef PCIE_PLL_CONFIG_UPDATING_MSB
#undef PCIE_PLL_CONFIG_UPDATING_RESET
#undef PCIE_PLL_CONFIG_UPDATING_SET
#undef PCIE_PLL_DITHER_DIV_MAX_ADDRESS
#undef PCIE_PLL_DITHER_DIV_MAX_DIV_MAX_FRAC_GET
#undef PCIE_PLL_DITHER_DIV_MAX_DIV_MAX_FRAC_LSB
#undef PCIE_PLL_DITHER_DIV_MAX_DIV_MAX_FRAC_MASK
#undef PCIE_PLL_DITHER_DIV_MAX_DIV_MAX_FRAC_MSB
#undef PCIE_PLL_DITHER_DIV_MAX_DIV_MAX_FRAC_RESET
#undef PCIE_PLL_DITHER_DIV_MAX_DIV_MAX_FRAC_SET
#undef PCIE_PLL_DITHER_DIV_MAX_DIV_MAX_INT_GET
#undef PCIE_PLL_DITHER_DIV_MAX_DIV_MAX_INT_LSB
#undef PCIE_PLL_DITHER_DIV_MAX_DIV_MAX_INT_MASK
#undef PCIE_PLL_DITHER_DIV_MAX_DIV_MAX_INT_MSB
#undef PCIE_PLL_DITHER_DIV_MAX_DIV_MAX_INT_RESET
#undef PCIE_PLL_DITHER_DIV_MAX_DIV_MAX_INT_SET
#undef PCIE_PLL_DITHER_DIV_MAX_EN_DITHER_GET
#undef PCIE_PLL_DITHER_DIV_MAX_EN_DITHER_LSB
#undef PCIE_PLL_DITHER_DIV_MAX_EN_DITHER_MASK
#undef PCIE_PLL_DITHER_DIV_MAX_EN_DITHER_MSB
#undef PCIE_PLL_DITHER_DIV_MAX_EN_DITHER_RESET
#undef PCIE_PLL_DITHER_DIV_MAX_EN_DITHER_SET
#undef PCIE_PLL_DITHER_DIV_MAX_OFFSET
#undef PCIE_PLL_DITHER_DIV_MAX_RESET
#undef PCIE_PLL_DITHER_DIV_MAX_RSTMASK
#undef PCIE_PLL_DITHER_DIV_MAX_SW_MASK
#undef PCIE_PLL_DITHER_DIV_MAX_USE_MAX_GET
#undef PCIE_PLL_DITHER_DIV_MAX_USE_MAX_LSB
#undef PCIE_PLL_DITHER_DIV_MAX_USE_MAX_MASK
#undef PCIE_PLL_DITHER_DIV_MAX_USE_MAX_MSB
#undef PCIE_PLL_DITHER_DIV_MAX_USE_MAX_RESET
#undef PCIE_PLL_DITHER_DIV_MAX_USE_MAX_SET
#undef PCIE_PLL_DITHER_DIV_MIN_ADDRESS
#undef PCIE_PLL_DITHER_DIV_MIN_DIV_MIN_FRAC_GET
#undef PCIE_PLL_DITHER_DIV_MIN_DIV_MIN_FRAC_LSB
#undef PCIE_PLL_DITHER_DIV_MIN_DIV_MIN_FRAC_MASK
#undef PCIE_PLL_DITHER_DIV_MIN_DIV_MIN_FRAC_MSB
#undef PCIE_PLL_DITHER_DIV_MIN_DIV_MIN_FRAC_RESET
#undef PCIE_PLL_DITHER_DIV_MIN_DIV_MIN_FRAC_SET
#undef PCIE_PLL_DITHER_DIV_MIN_DIV_MIN_INT_GET
#undef PCIE_PLL_DITHER_DIV_MIN_DIV_MIN_INT_LSB
#undef PCIE_PLL_DITHER_DIV_MIN_DIV_MIN_INT_MASK
#undef PCIE_PLL_DITHER_DIV_MIN_DIV_MIN_INT_MSB
#undef PCIE_PLL_DITHER_DIV_MIN_DIV_MIN_INT_RESET
#undef PCIE_PLL_DITHER_DIV_MIN_DIV_MIN_INT_SET
#undef PCIE_PLL_DITHER_DIV_MIN_OFFSET
#undef PCIE_PLL_DITHER_DIV_MIN_RESET
#undef PCIE_PLL_DITHER_DIV_MIN_RSTMASK
#undef PCIE_PLL_DITHER_DIV_MIN_SW_MASK
#undef PCIE_PLL_DITHER_STEP_ADDRESS
#undef PCIE_PLL_DITHER_STEP_OFFSET
#undef PCIE_PLL_DITHER_STEP_RESET
#undef PCIE_PLL_DITHER_STEP_RSTMASK
#undef PCIE_PLL_DITHER_STEP_STEP_FRAC_GET
#undef PCIE_PLL_DITHER_STEP_STEP_FRAC_LSB
#undef PCIE_PLL_DITHER_STEP_STEP_FRAC_MASK
#undef PCIE_PLL_DITHER_STEP_STEP_FRAC_MSB
#undef PCIE_PLL_DITHER_STEP_STEP_FRAC_RESET
#undef PCIE_PLL_DITHER_STEP_STEP_FRAC_SET
#undef PCIE_PLL_DITHER_STEP_STEP_INT_GET
#undef PCIE_PLL_DITHER_STEP_STEP_INT_LSB
#undef PCIE_PLL_DITHER_STEP_STEP_INT_MASK
#undef PCIE_PLL_DITHER_STEP_STEP_INT_MSB
#undef PCIE_PLL_DITHER_STEP_STEP_INT_RESET
#undef PCIE_PLL_DITHER_STEP_STEP_INT_SET
#undef PCIE_PLL_DITHER_STEP_SW_MASK
#undef PCIE_PLL_DITHER_STEP_UPDATE_CNT_GET
#undef PCIE_PLL_DITHER_STEP_UPDATE_CNT_LSB
#undef PCIE_PLL_DITHER_STEP_UPDATE_CNT_MASK
#undef PCIE_PLL_DITHER_STEP_UPDATE_CNT_MSB
#undef PCIE_PLL_DITHER_STEP_UPDATE_CNT_RESET
#undef PCIE_PLL_DITHER_STEP_UPDATE_CNT_SET
#undef PERF_CTL_GE0_PKT_CNT
#undef PERF_CTL_GE1_AHB_1
#undef PERF_CTL_GE1_PKT_CNT
#undef PERF_CTL_GEO_AHB_1
#undef PERF_CTL_HOST_ACTIVE
#undef PERF_CTL_PCI_AHB_0
#undef PERF_CTL_PCI_AHB_1
#undef PERF_CTL_PCI_DEV_0_ACTIVE
#undef PERF_CTL_PCI_DEV_0_ARB
#undef PERF_CTL_PCI_DEV_0_BUSY
#undef PERF_CTL_PCI_DEV_1_ACTIVE
#undef PERF_CTL_PCI_DEV_1_ARB
#undef PERF_CTL_PCI_DEV_1_BUSY
#undef PERF_CTL_PCI_DEV_2_ACTIVE
#undef PERF_CTL_PCI_DEV_2_ARB
#undef PERF_CTL_PCI_DEV_2_BUSY
#undef PERF_CTL_PCI_HOST_ARB
#undef PERF_CTL_PCI_HOST_BUSY
#undef PERF_CTL_USB_0
#undef PERF_CTL_USB_1
#undef PIMR_CORE
#undef PIMR_DEV0
#undef PIMR_DEV1
#undef PIMR_DEV2
...
#undef REF_DIV_MASK
#undef REF_DIV_SHIFT
#undef RST_RESET_ADDRESS
#undef RST_RESET_CHKSUM_ACC_RESET_GET
#undef RST_RESET_CHKSUM_ACC_RESET_LSB
#undef RST_RESET_CHKSUM_ACC_RESET_MASK
#undef RST_RESET_CHKSUM_ACC_RESET_MSB
#undef RST_RESET_CHKSUM_ACC_RESET_RESET
#undef RST_RESET_CHKSUM_ACC_RESET_SET
#undef RST_RESET_CPU_COLD_RESET_GET
#undef RST_RESET_CPU_COLD_RESET_LSB
#undef RST_RESET_CPU_COLD_RESET_MASK
#undef RST_RESET_CPU_COLD_RESET_MSB
#undef RST_RESET_CPU_COLD_RESET_RESET
#undef RST_RESET_CPU_COLD_RESET_SET
#undef RST_RESET_CPU_NMI_GET
#undef RST_RESET_CPU_NMI_LSB
#undef RST_RESET_CPU_NMI_MASK
#undef RST_RESET_CPU_NMI_MSB
#undef RST_RESET_CPU_NMI_RESET
#undef RST_RESET_CPU_NMI_SET
#undef RST_RESET_DDR_RESET_GET
#undef RST_RESET_DDR_RESET_LSB
#undef RST_RESET_DDR_RESET_MASK
#undef RST_RESET_DDR_RESET_MSB
#undef RST_RESET_DDR_RESET_RESET
#undef RST_RESET_DDR_RESET_SET
#undef RST_RESET_ETH_SWITCH_ARESET_GET
#undef RST_RESET_ETH_SWITCH_ARESET_LSB
#undef RST_RESET_ETH_SWITCH_ARESET_MASK
#undef RST_RESET_ETH_SWITCH_ARESET_MSB
#undef RST_RESET_ETH_SWITCH_ARESET_RESET
#undef RST_RESET_ETH_SWITCH_ARESET_SET
#undef RST_RESET_ETH_SWITCH_RESET_GET
#undef RST_RESET_ETH_SWITCH_RESET_LSB
#undef RST_RESET_ETH_SWITCH_RESET_MASK
#undef RST_RESET_ETH_SWITCH_RESET_MSB
#undef RST_RESET_ETH_SWITCH_RESET_RESET
#undef RST_RESET_ETH_SWITCH_RESET_SET
#undef RST_RESET_EXTERNAL_RESET_GET
#undef RST_RESET_EXTERNAL_RESET_LSB
#undef RST_RESET_EXTERNAL_RESET_MASK
#undef RST_RESET_EXTERNAL_RESET_MSB
#undef RST_RESET_EXTERNAL_RESET_RESET
#undef RST_RESET_EXTERNAL_RESET_SET
#undef RST_RESET_FULL_CHIP_RESET_GET
#undef RST_RESET_FULL_CHIP_RESET_LSB
#undef RST_RESET_FULL_CHIP_RESET_MASK
#undef RST_RESET_FULL_CHIP_RESET_MSB
#undef RST_RESET_FULL_CHIP_RESET_RESET
#undef RST_RESET_FULL_CHIP_RESET_SET
#undef RST_RESET_GE0_MAC_RESET_GET
#undef RST_RESET_GE0_MAC_RESET_LSB
#undef RST_RESET_GE0_MAC_RESET_MASK
#undef RST_RESET_GE0_MAC_RESET_MSB
#undef RST_RESET_GE0_MAC_RESET_RESET
#undef RST_RESET_GE0_MAC_RESET_SET
#undef RST_RESET_GE0_MDIO_RESET_GET
#undef RST_RESET_GE0_MDIO_RESET_LSB
#undef RST_RESET_GE0_MDIO_RESET_MASK
#undef RST_RESET_GE0_MDIO_RESET_MSB
#undef RST_RESET_GE0_MDIO_RESET_RESET
#undef RST_RESET_GE0_MDIO_RESET_SET
#undef RST_RESET_GE1_MAC_RESET_GET
#undef RST_RESET_GE1_MAC_RESET_LSB
#undef RST_RESET_GE1_MAC_RESET_MASK
#undef RST_RESET_GE1_MAC_RESET_MSB
#undef RST_RESET_GE1_MAC_RESET_RESET
#undef RST_RESET_GE1_MAC_RESET_SET
#undef RST_RESET_GE1_MDIO_RESET_GET
#undef RST_RESET_GE1_MDIO_RESET_LSB
#undef RST_RESET_GE1_MDIO_RESET_MASK
#undef RST_RESET_GE1_MDIO_RESET_MSB
#undef RST_RESET_GE1_MDIO_RESET_RESET
#undef RST_RESET_GE1_MDIO_RESET_SET
#undef RST_RESET_HDMA_RESET_GET
#undef RST_RESET_HDMA_RESET_LSB
#undef RST_RESET_HDMA_RESET_MASK
#undef RST_RESET_HDMA_RESET_MSB
#undef RST_RESET_HDMA_RESET_RESET
#undef RST_RESET_HDMA_RESET_SET
#undef RST_RESET_HOST_DMA_INT_GET
#undef RST_RESET_HOST_DMA_INT_LSB
#undef RST_RESET_HOST_DMA_INT_MASK
#undef RST_RESET_HOST_DMA_INT_MSB
#undef RST_RESET_HOST_DMA_INT_RESET
#undef RST_RESET_HOST_DMA_INT_SET
#undef RST_RESET_HOST_RESET_GET
#undef RST_RESET_HOST_RESET_INT_GET
#undef RST_RESET_HOST_RESET_INT_LSB
#undef RST_RESET_HOST_RESET_INT_MASK
#undef RST_RESET_HOST_RESET_INT_MSB
#undef RST_RESET_HOST_RESET_INT_RESET
#undef RST_RESET_HOST_RESET_INT_SET
#undef RST_RESET_HOST_RESET_LSB
#undef RST_RESET_HOST_RESET_MASK
#undef RST_RESET_HOST_RESET_MSB
#undef RST_RESET_HOST_RESET_RESET
#undef RST_RESET_HOST_RESET_SET
#undef RST_RESET_I2S_RESET_GET
#undef RST_RESET_I2S_RESET_LSB
#undef RST_RESET_I2S_RESET_MASK
#undef RST_RESET_I2S_RESET_MSB
#undef RST_RESET_I2S_RESET_RESET
#undef RST_RESET_I2S_RESET_SET
#undef RST_RESET_LUT_RESET_GET
#undef RST_RESET_LUT_RESET_LSB
#undef RST_RESET_LUT_RESET_MASK
#undef RST_RESET_LUT_RESET_MSB
#undef RST_RESET_LUT_RESET_RESET
#undef RST_RESET_LUT_RESET_SET
#undef RST_RESET_MBOX_RESET_GET
#undef RST_RESET_MBOX_RESET_LSB
#undef RST_RESET_MBOX_RESET_MASK
#undef RST_RESET_MBOX_RESET_MSB
#undef RST_RESET_MBOX_RESET_RESET
#undef RST_RESET_MBOX_RESET_SET
#undef RST_RESET_NANDF_RESET_GET
#undef RST_RESET_NANDF_RESET_LSB
#undef RST_RESET_NANDF_RESET_MASK
#undef RST_RESET_NANDF_RESET_MSB
#undef RST_RESET_NANDF_RESET_RESET
#undef RST_RESET_NANDF_RESET_SET
#undef RST_RESET_OFFSET
#undef RST_RESET_PCIEEP_RESET_GET
#undef RST_RESET_PCIEEP_RESET_LSB
#undef RST_RESET_PCIEEP_RESET_MASK
#undef RST_RESET_PCIEEP_RESET_MSB
#undef RST_RESET_PCIEEP_RESET_RESET
#undef RST_RESET_PCIEEP_RESET_SET
#undef RST_RESET_PCIEEP_RST_INT_GET
#undef RST_RESET_PCIEEP_RST_INT_LSB
#undef RST_RESET_PCIEEP_RST_INT_MASK
#undef RST_RESET_PCIEEP_RST_INT_MSB
#undef RST_RESET_PCIEEP_RST_INT_RESET
#undef RST_RESET_PCIEEP_RST_INT_SET
#undef RST_RESET_PCIE_PHY_RESET_GET
#undef RST_RESET_PCIE_PHY_RESET_LSB
#undef RST_RESET_PCIE_PHY_RESET_MASK
#undef RST_RESET_PCIE_PHY_RESET_MSB
#undef RST_RESET_PCIE_PHY_RESET_RESET
#undef RST_RESET_PCIE_PHY_RESET_SET
#undef RST_RESET_PCIE_RESET_GET
#undef RST_RESET_PCIE_RESET_LSB
#undef RST_RESET_PCIE_RESET_MASK
#undef RST_RESET_PCIE_RESET_MSB
#undef RST_RESET_PCIE_RESET_RESET
#undef RST_RESET_PCIE_RESET_SET
#undef RST_RESET_RESET
#undef RST_RESET_RSTMASK
#undef RST_RESET_RTC_RESET_GET
#undef RST_RESET_RTC_RESET_LSB
#undef RST_RESET_RTC_RESET_MASK
#undef RST_RESET_RTC_RESET_MSB
#undef RST_RESET_RTC_RESET_RESET
#undef RST_RESET_RTC_RESET_SET
#undef RST_RESET_SLIC_RESET_GET
#undef RST_RESET_SLIC_RESET_LSB
#undef RST_RESET_SLIC_RESET_MASK
#undef RST_RESET_SLIC_RESET_MSB
#undef RST_RESET_SLIC_RESET_RESET
#undef RST_RESET_SLIC_RESET_SET
#undef RST_RESET_SW_MASK
#undef RST_RESET_UART1_RESET_GET
#undef RST_RESET_UART1_RESET_LSB
#undef RST_RESET_UART1_RESET_MASK
#undef RST_RESET_UART1_RESET_MSB
#undef RST_RESET_UART1_RESET_RESET
#undef RST_RESET_UART1_RESET_SET
#undef RST_RESET_USB_HOST_RESET_GET
#undef RST_RESET_USB_HOST_RESET_LSB
#undef RST_RESET_USB_HOST_RESET_MASK
#undef RST_RESET_USB_HOST_RESET_MSB
#undef RST_RESET_USB_HOST_RESET_RESET
#undef RST_RESET_USB_HOST_RESET_SET
#undef RST_RESET_USB_PHY_ARESET_GET
#undef RST_RESET_USB_PHY_ARESET_LSB
#undef RST_RESET_USB_PHY_ARESET_MASK
#undef RST_RESET_USB_PHY_ARESET_MSB
#undef RST_RESET_USB_PHY_ARESET_RESET
#undef RST_RESET_USB_PHY_ARESET_SET
#undef RST_RESET_USB_PHY_PLL_PWD_EXT_GET
#undef RST_RESET_USB_PHY_PLL_PWD_EXT_LSB
#undef RST_RESET_USB_PHY_PLL_PWD_EXT_MASK
#undef RST_RESET_USB_PHY_PLL_PWD_EXT_MSB
#undef RST_RESET_USB_PHY_PLL_PWD_EXT_RESET
#undef RST_RESET_USB_PHY_PLL_PWD_EXT_SET
#undef RST_RESET_USB_PHY_RESET_GET
#undef RST_RESET_USB_PHY_RESET_LSB
#undef RST_RESET_USB_PHY_RESET_MASK
#undef RST_RESET_USB_PHY_RESET_MSB
#undef RST_RESET_USB_PHY_RESET_RESET
#undef RST_RESET_USB_PHY_RESET_SET
#undef RST_RESET_USB_PHY_SUSPEND_OVERRIDE_GET
#undef RST_RESET_USB_PHY_SUSPEND_OVERRIDE_LSB
#undef RST_RESET_USB_PHY_SUSPEND_OVERRIDE_MASK
#undef RST_RESET_USB_PHY_SUSPEND_OVERRIDE_MSB
#undef RST_RESET_USB_PHY_SUSPEND_OVERRIDE_RESET
#undef RST_RESET_USB_PHY_SUSPEND_OVERRIDE_SET
#undef SWITCH_CLOCK_SPARE_ADDRESS
#undef SWITCH_CLOCK_SPARE_EEE_ENABLE_GET
#undef SWITCH_CLOCK_SPARE_EEE_ENABLE_LSB
#undef SWITCH_CLOCK_SPARE_EEE_ENABLE_MASK
#undef SWITCH_CLOCK_SPARE_EEE_ENABLE_MSB
#undef SWITCH_CLOCK_SPARE_EEE_ENABLE_RESET
#undef SWITCH_CLOCK_SPARE_EEE_ENABLE_SET
#undef SWITCH_CLOCK_SPARE_EN_PLL_TOP_GET
#undef SWITCH_CLOCK_SPARE_EN_PLL_TOP_LSB
#undef SWITCH_CLOCK_SPARE_EN_PLL_TOP_MASK
#undef SWITCH_CLOCK_SPARE_EN_PLL_TOP_MSB
#undef SWITCH_CLOCK_SPARE_EN_PLL_TOP_RESET
#undef SWITCH_CLOCK_SPARE_EN_PLL_TOP_SET
#undef SWITCH_CLOCK_SPARE_MDIO_CLK_SEL_GET
#undef SWITCH_CLOCK_SPARE_MDIO_CLK_SEL_LSB
#undef SWITCH_CLOCK_SPARE_MDIO_CLK_SEL_MASK
#undef SWITCH_CLOCK_SPARE_MDIO_CLK_SEL_MSB
#undef SWITCH_CLOCK_SPARE_MDIO_CLK_SEL_RESET
#undef SWITCH_CLOCK_SPARE_MDIO_CLK_SEL_SET
#undef SWITCH_CLOCK_SPARE_OEN_CLK125M_PLL_GET
#undef SWITCH_CLOCK_SPARE_OEN_CLK125M_PLL_LSB
#undef SWITCH_CLOCK_SPARE_OEN_CLK125M_PLL_MASK
#undef SWITCH_CLOCK_SPARE_OEN_CLK125M_PLL_MSB
#undef SWITCH_CLOCK_SPARE_OEN_CLK125M_PLL_RESET
#undef SWITCH_CLOCK_SPARE_OEN_CLK125M_PLL_SET
#undef SWITCH_CLOCK_SPARE_OFFSET
#undef SWITCH_CLOCK_SPARE_RESET
#undef SWITCH_CLOCK_SPARE_RSTMASK
#undef SWITCH_CLOCK_SPARE_SPARE_GET
#undef SWITCH_CLOCK_SPARE_SPARE_LSB
#undef SWITCH_CLOCK_SPARE_SPARE_MASK
#undef SWITCH_CLOCK_SPARE_SPARE_MSB
#undef SWITCH_CLOCK_SPARE_SPARE_RESET
#undef SWITCH_CLOCK_SPARE_SPARE_SET
#undef SWITCH_CLOCK_SPARE_SWITCHCLK_FROM_PYTHON_OFF_GET
#undef SWITCH_CLOCK_SPARE_SWITCHCLK_FROM_PYTHON_OFF_LSB
#undef SWITCH_CLOCK_SPARE_SWITCHCLK_FROM_PYTHON_OFF_MASK
#undef SWITCH_CLOCK_SPARE_SWITCHCLK_FROM_PYTHON_OFF_MSB
#undef SWITCH_CLOCK_SPARE_SWITCHCLK_FROM_PYTHON_OFF_RESET
#undef SWITCH_CLOCK_SPARE_SWITCHCLK_FROM_PYTHON_OFF_SET
#undef SWITCH_CLOCK_SPARE_SWITCHCLK_SEL_GET
#undef SWITCH_CLOCK_SPARE_SWITCHCLK_SEL_LSB
#undef SWITCH_CLOCK_SPARE_SWITCHCLK_SEL_MASK
#undef SWITCH_CLOCK_SPARE_SWITCHCLK_SEL_MSB
#undef SWITCH_CLOCK_SPARE_SWITCHCLK_SEL_RESET
#undef SWITCH_CLOCK_SPARE_SWITCHCLK_SEL_SET
#undef SWITCH_CLOCK_SPARE_SWITCH_FUNC_TST_MODE_GET
#undef SWITCH_CLOCK_SPARE_SWITCH_FUNC_TST_MODE_LSB
#undef SWITCH_CLOCK_SPARE_SWITCH_FUNC_TST_MODE_MASK
#undef SWITCH_CLOCK_SPARE_SWITCH_FUNC_TST_MODE_MSB
#undef SWITCH_CLOCK_SPARE_SWITCH_FUNC_TST_MODE_RESET
#undef SWITCH_CLOCK_SPARE_SWITCH_FUNC_TST_MODE_SET
#undef SWITCH_CLOCK_SPARE_SW_MASK
#undef SWITCH_CLOCK_SPARE_UART1_CLK_SEL_GET
#undef SWITCH_CLOCK_SPARE_UART1_CLK_SEL_LSB
#undef SWITCH_CLOCK_SPARE_UART1_CLK_SEL_MASK
#undef SWITCH_CLOCK_SPARE_UART1_CLK_SEL_MSB
#undef SWITCH_CLOCK_SPARE_UART1_CLK_SEL_RESET
#undef SWITCH_CLOCK_SPARE_UART1_CLK_SEL_SET
#undef SWITCH_CLOCK_SPARE_USB_REFCLK_FREQ_SEL_GET
#undef SWITCH_CLOCK_SPARE_USB_REFCLK_FREQ_SEL_LSB
#undef SWITCH_CLOCK_SPARE_USB_REFCLK_FREQ_SEL_MASK
#undef SWITCH_CLOCK_SPARE_USB_REFCLK_FREQ_SEL_MSB
#undef SWITCH_CLOCK_SPARE_USB_REFCLK_FREQ_SEL_RESET
#undef SWITCH_CLOCK_SPARE_USB_REFCLK_FREQ_SEL_SET
