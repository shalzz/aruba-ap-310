 ...
 * \return         0 if successful, or an XYSSL_ERR_MPI_XXX error code
 */
// int mpi_read_file( mpi *X, int radix, FILE *fin );   // not porting if not used bevins
 ...
 */
// int mpi_write_file( char *p, mpi *X, int radix, FILE *fout );    // not porting if not used bevins
