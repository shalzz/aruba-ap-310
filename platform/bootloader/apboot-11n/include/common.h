...
#if !defined(AR7100) && !defined(powerpc) && !defined(CONFIG_IPROC) && \
    !defined(CONFIG_MACH_IPQ806x)
...
ulong crc32_wd (ulong, const unsigned char *, uint, uint);
...
// Hack to print long longs - use format of %08x%08x
#define ARG64(x)  (uint32_t)(((x) >> 32) & 0xffffffff),(uint32_t)((x) & 0xFFFFFFFF)
