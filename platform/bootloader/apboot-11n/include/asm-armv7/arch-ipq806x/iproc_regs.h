...
#define APBW_IDM_IDM_IO_CONTROL_DIRECT_BASE 0x408
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__RESERVED_3 30
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__RESERVED_3_WIDTH 1
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__RESERVED_3_RESETVALUE 0x0
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__ARCACHE_JTAG_m0_L 27
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__ARCACHE_JTAG_m0_R 24
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__ARCACHE_JTAG_m0_WIDTH 4
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__ARCACHE_JTAG_m0_RESETVALUE 0xf
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__AWCACHE_JTAG_m0_L 23
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__AWCACHE_JTAG_m0_R 20
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__AWCACHE_JTAG_m0_WIDTH 4
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__AWCACHE_JTAG_m0_RESETVALUE 0xf
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__RESERVED_2_L 19
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__RESERVED_2_R 18
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__RESERVED_2_WIDTH 2
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__RESERVED_2_RESETVALUE 0x0
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__UARTClkSel 17
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__UARTClkSel_WIDTH 1
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__UARTClkSel_RESETVALUE 0x1
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__otp_power_ready 16
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__otp_power_ready_WIDTH 1
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__otp_power_ready_RESETVALUE 0x1
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__initiate_BIST 15
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__initiate_BIST_WIDTH 1
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__initiate_BIST_RESETVALUE 0x0
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__RESERVED_1_L 14
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__RESERVED_1_R 2
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__RESERVED_1_WIDTH 13
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__RESERVED_1_RESETVALUE 0x1fff
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__forceClocksOn 1
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__forceClocksOn_WIDTH 1
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__forceClocksOn_RESETVALUE 0x1
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__clk_enable 0
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__clk_enable_WIDTH 1
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__clk_enable_RESETVALUE 0x1
#define APBW_IDM_IDM_IO_CONTROL_DIRECT_WIDTH 31
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__WIDTH 31
#define APBW_IDM_IDM_IO_CONTROL_DIRECT_ALL_L 30
#define APBW_IDM_IDM_IO_CONTROL_DIRECT_ALL_R 0
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__ALL_L 30
#define APBW_IDM_IDM_IO_CONTROL_DIRECT__ALL_R 0
#define APBW_IDM_IDM_IO_CONTROL_DIRECT_DATAMASK 0x4fffffff
#define APBW_IDM_IDM_IO_CONTROL_DIRECT_RDWRMASK 0xb0000000
#define APBW_IDM_IDM_IO_CONTROL_DIRECT_RESETVALUE 0xff37fff

#define DMU_CRU_RESET 0x1803f200  /* fixme_db149 */
#define CONFIG_SYS_REF_CLK			(25000000) /*fixme_db149 Reference clock = 25MHz */
