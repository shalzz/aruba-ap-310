 ...
 *
 * $Id: nodelist.h,v 1.1.1.4.2.2 2006/05/24 17:38:48 vvadapalli Exp $
 *
 */
...
#include <jffs2/jffs2_fs_sb.h>
#include <jffs2/jffs2_fs_i.h>
#include <jffs2/summary.h>
...
#define cpu_to_je16(x) ((uint16_t){x})
#define cpu_to_je32(x) ((uint32_t){x})
				    ...
				    struct jffs2_raw_node_ref *ref)
{
	...
	if (ref->next_phys)
		...
		if(ref != jeb->last_node) printf("Well EXCUSE ME!\n");
