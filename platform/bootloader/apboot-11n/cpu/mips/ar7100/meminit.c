...
void ar7100_ddr_tap_config(void)
{
    ...
    int i, j, k, floor = 0, ceiling = 0;
    uint16_t *p = (uint16_t *)0xa0003000, *p_ca = (uint16_t *)0x80003000;
...
ar7100_ddr_width_t
ar7100_ddr_get_width(void)
{
    volatile uint32_t *p = (uint32_t *)0xa0000000, *p1 = (uint32_t *)0xa0001000;
...
int sanity_mem_check(int mem_size) 
{
	int data=0xaaaa5555,i,ret=0;
        volatile unsigned int *ptr = (unsigned int *)KSEG1;
#ifdef ARUBA_AR7100
	int cnt = 0;
#endif
