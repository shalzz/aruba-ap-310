...
#ifdef CONFIG_IPROC
extern void iproc_l2_cache_flush_range(unsigned long, unsigned long);
#endif
/*
...
void  flush_cache(unsigned long start, unsigned long size)
{
	...
	/* invalidate I$ inner shareable -- taken from Linux SMP */
	asm volatile ("mcr     p15, 0, r0, c7, c1, 0");
	iproc_l2_cache_flush_range(start, start + size);
#endif
}
