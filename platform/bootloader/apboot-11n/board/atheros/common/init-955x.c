...
#if defined(CONFIG_TB614) || defined(CONFIG_ARDBEG) || defined(CONFIG_BOWMORE)
...
#if defined(CONFIG_ARDBEG) || defined(CONFIG_BOWMORE)
/* tap calibration can override this */
#undef CFG_DDR2_TAP_VAL
#define CFG_DDR2_TAP_VAL			0x12
#endif
...
#endif
	uint32_t ref = 0;
	uint32_t ath_cpu_freq, ath_ddr_freq, ath_ahb_freq;
