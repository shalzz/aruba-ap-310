...
{
	/* 
	 * for PCIe, return all ones for devices > 0 unless they are on a 
	 * bridge
	 */
...
void plat_dev_init(void)
{
	...
	*/
	if ((is_ar7241() || is_ar7242()))
		ath_pci_write_config(&hose, 0, 0x10, 0x1000ffff);
	else
		ath_pci_write_config(&hose, 0, 0x10, 0xffff);

	ath_pci_write_config(&hose, 0, 0x04, 0x6);

	ath_pci_write_config_rc2(&hose, 0, 0x10, 0xffff);

	ath_pci_write_config_rc2(&hose, 0, 0x04, 0x6);
	/*
