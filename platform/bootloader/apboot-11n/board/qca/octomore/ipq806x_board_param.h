...
board_ipq806x_params_t board_params[] = {
	...
	},
	{
        ...
        /* Marvell 88E1514 on SGMII with PHY Address = 0, GMAC3(.base = 2); 
           Marvell 88E1514 on SGMII with PHY Address = 1, GMAC4(.base = 3) */
		.gmac_gpio_count = ARRAY_SIZE(gmac2_gpio),
		.gmac_gpio = gmac2_gpio,
		.gmac_cfg = {
			gmac_board_cfg(2, 1, SGMII, 0, 0, 1, 1, 0),
			gmac_board_cfg(3, 1, SGMII, 0, 0, 1, 1, 1),
			gmac_board_cfg_invalid(),
			gmac_board_cfg_invalid(),
		},
#else
