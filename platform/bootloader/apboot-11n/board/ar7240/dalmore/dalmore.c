...
/* scratch-pad address used for Dalmore */
...
#ifdef CONFIG_AR5416
    ar5416_install_callback(dalmore_radio_callback);
    ar5416_initialize();
#endif
#ifdef CONFIG_ATH_WMAC
    ath_wmac_install_callback(dalmore_radio_callback);
