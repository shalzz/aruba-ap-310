...
void puts (const char *s)
{
	...
	if (gd->flags & GD_FLG_DEVINIT) {
		...
		/* Send directly to the handler */
		serial_puts (s);  // calls func. in: board/purple/sconsole.c
	}
}
...
int console_init_r (void)
{
    ...
    stdio_names[0] = "stdin";   // On platforms where we are running relocated, these pointers need
    stdio_names[1] = "stdout";  // to be fixed.
