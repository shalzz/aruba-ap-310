...
struct upstream {
        ...
        char *auth_url;
        char *oosurl;
        char *login_success_string;
        char *redirecturl;
        unsigned int query_in_auth_url;   /* boolean */
        unsigned int usehttps;
        unsigned int serverfailthrough;
        unsigned int autowhitelist;
        unsigned int serveroffload;
        unsigned int preventframeoverlay;
        unsigned int useredirect;
        unsigned int switchip;
        ecp_server_cfg_t *ecp_server_cfg;
#endif
};
