...
struct dhcp_option dhcp_options[] = {
	...
	{"timesvr",	OPTION_IP | OPTION_LIST | OPTION_REQ,		0x04},
...
#ifdef __FAT_AP__
	{"vsa",	    	OPTION_STRING | OPTION_REQ,		0x2b},
#else
	{"vsa",	    	OPTION_IP | OPTION_REQ,			0x2b},
#endif
    ...
    {"vendor", OPTION_STRING | OPTION_REQ,          0x3c},
#ifdef __FAT_AP__
...
#endif
#ifdef __FAT_AP__
    {"httpproxy",    OPTION_STRING | OPTION_REQ,      0x94},
#endif
	{"",		0x00,				0x00}
};
...
#if defined(AP_PLATFORM)
    if (end + string[OPT_LEN] + 2 + 1 >= MAX_OPTIONS_LENGTH) {
#else
