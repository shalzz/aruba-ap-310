...
-include $(ARUBA_SRC)/utils/busybox-1.01/.config
endif
...
ifeq ($(strip $(CONFIG_DEBUG)),y)
    ...
    LDFLAGS += -Wl,-warn-common
    STRIPCMD:=$(STRIP) -s --remove-section=.note --remove-section=.comment --remove-section=.pdr
endif
...
ifndef SWITCH_PLATFORM
OBJECTS   += $(ARUBA_SRC)/sap/sapm/des_enc.o
endif
CFLAGS    += $(CROSS_CFLAGS)
