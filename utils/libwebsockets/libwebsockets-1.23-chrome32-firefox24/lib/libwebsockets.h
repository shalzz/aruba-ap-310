...
typedef enum
{
    ...
    AWC_PROXY_ERROR,
    AWC_SSL_ERROR,
    AWC_SSL_CONNECT_ERROR,
    AWC_SSL_CERT_VERIFICATION_ERROR,
    AWC_SSL_CERT_CN_NAME_ERROR,
    AWC_SSL_TPM_CLIENTAUTH_ERROR,
    AWC_SSL_CACERT_ERROR,
    AWC_PROTOCOL_ERROR,
    AWC_HANDSHACK_ERROR
} awc_error_t;

extern awc_error_t wsc_err;
extern char wsc_err_str[256];

extern void WSC_ERROR(awc_error_t arg, const char *str);
extern void WSC_ERROR_CLEAR();
extern void WSC_ERROR_GET(char* str, int len);
#endif
