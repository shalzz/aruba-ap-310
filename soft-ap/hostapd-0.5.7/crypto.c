...
/*
 * Aruba Networks : Harsha
 * Need these wrapper functions to link against OpenSSL
 */

#if defined(EAP_TLS_FUNCS) || defined(__FIPS_BUILD__)
...
#endif /* EAP_TLS_FUNCS || __FIPS_BUILD__*/
