...
extern int			addrconf_set_dstaddr(struct net *net,
						     void __user *arg);
extern int                      addrconf_trigger_router_discovery(struct net *net,
                                                                  void __user *arg);
...
extern int ipv6_get_saddr(struct dst_entry *dst,const struct in6_addr *daddr, struct in6_addr *saddr);
#endif
