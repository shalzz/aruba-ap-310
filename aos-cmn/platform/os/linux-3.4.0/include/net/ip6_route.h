...
#define RT6_LOOKUP_F_SADDR_IGNORE       0x00000040
...
extern int rt6_register_notifier(struct notifier_block *nb);
extern int rt6_unregister_notifier(struct notifier_block *nb);
