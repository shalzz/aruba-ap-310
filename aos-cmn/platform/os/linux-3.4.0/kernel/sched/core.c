...
static int irqtime_account_si_update(void)
{
	 ...
	 * time to correctly to the ksoftirqd task), but
...
int set_cpus_allowed_aruba(struct task_struct *p, const struct cpumask new_mask)
{
    return set_cpus_allowed_ptr(p,&new_mask);
}
EXPORT_SYMBOL(set_cpus_allowed_aruba);
#endif
/*
