...
#define USB_DEV_EXTRA_MAX       4
static int usb_dev[USB_DEV_EXTRA_MAX] = {0,};
static int nr_usb_dev;
module_param_array(usb_dev, int, &nr_usb_dev, S_IRUGO | S_IWUSR);
MODULE_PARM_DESC(usb_dev, "supply vendor ID and product ID for usb device");
