...
static struct gpiomux_setting pcie_rst_n_toba = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
static struct gpiomux_setting ipq806x_i2c_sda_ap32x_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
	.dir = GPIOMUX_OUT_LOW,
...
static struct gpiomux_setting ipq806x_i2c_scl_ap32x_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
	.dir = GPIOMUX_OUT_HIGH,
...
static struct gpiomux_setting pm_in_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
	.dir = GPIOMUX_IN,
...
static struct msm_gpiomux_config ipq806x_ap32x_gpiomux[] = {
	ipq_mux( 0, mdio_n,				mdio_n),
	ipq_mux( 1, mdio_n,				mdio_n),
	ipq_mux( 3, pcie_rst_n,				pcie_rst_n),
	ipq_mux(12, gsbi4_active_cfg,			gsbi4_suspended_cfg),
	...
	ipq_mux(20, gsbi5_spi_cs_cfg,			gsbi5_spi_cs_cfg),
	ipq_mux(21, gsbi5_spi_clk_cfg,			gsbi5_spi_clk_cfg),
/* GPIO -22,23 configured in their primary function- FUNC_1 mode, for GSBI UART2 */
	ipq_mux(22, gsbi2_active_cfg,			gsbi2_suspended_cfg),
	ipq_mux(23, gsbi2_active_cfg,			gsbi2_suspended_cfg),
	ipq_mux(24, ipq806x_i2c_sda_ap32x_cfg,			ipq806x_i2c_sda_ap32x_cfg),
	ipq_mux(25, ipq806x_i2c_scl_ap32x_cfg,			ipq806x_i2c_scl_ap32x_cfg),
	ipq_mux(48, pcie_rst_n,				pcie_rst_n),
	ipq_mux(60, pm_in_cfg,				pm_in_cfg),
};

static struct msm_gpiomux_config ipq806x_ap385_gpiomux[] = {
    ipq_mux( 0, mdio_n,                     mdio_n),
    ipq_mux( 1, mdio_n,                     mdio_n),
    ipq_mux( 3, pcie_rst_n,                 pcie_rst_n),
    ipq_mux( 6, gsbi7_active_cfg,           gsbi7_suspended_cfg),
    ipq_mux( 7, gsbi7_active_cfg,           gsbi7_suspended_cfg),
	ipq_mux( 8, ipq806x_i2c_sda_ap32x_cfg,	ipq806x_i2c_sda_ap32x_cfg),
	ipq_mux( 9, ipq806x_i2c_scl_ap32x_cfg,	ipq806x_i2c_scl_ap32x_cfg),
    ipq_mux(12, gsbi4_active_cfg,           gsbi4_suspended_cfg),
    ipq_mux(13, gsbi4_active_cfg,           gsbi4_suspended_cfg),
    ipq_mux(14, pcm_out_act_cfg,            pcm_out_sus_cfg),
    ipq_mux(16, pcm_out_act_cfg,            pcm_out_sus_cfg),
...
static struct msm_gpiomux_config ipq806x_ap387_gpiomux[] = {
    ipq_mux( 0, mdio_n,                     mdio_n),
    ipq_mux( 1, mdio_n,                     mdio_n),
    ipq_mux( 3, pcie_rst_n,                 pcie_rst_n),
    ipq_mux( 6, gsbi7_active_cfg,           gsbi7_suspended_cfg),
...
static struct msm_gpiomux_config ipq806x_sierra_gpiomux[] = {
    ipq_mux( 0, mdio_n,                     mdio_n),
    ipq_mux( 1, mdio_n,                     mdio_n),
    ipq_mux( 3, pcie_rst_n,                 pcie_rst_n),
    ipq_mux( 6, gsbi7_active_cfg,           gsbi7_suspended_cfg),
...
static struct msm_gpiomux_config ipq806x_ap145_gpiomux[] = {
	...
	ipq_mux(31, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	ipq_mux(32, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	ipq_mux(33, ipq806x_leds_cfg,			ipq806x_leds_cfg),
	ipq_mux(48, pcie_rst_n,					pcie_rst_n),
	ipq_mux(51, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	ipq_mux(52, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
...
static struct msm_gpiomux_config ipq806x_ap160_gpiomux[] = {
	...
	ipq_mux( 1, mdio_n,				mdio_n),
	ipq_mux( 2, nss_gmac0_rgmii_set0,		nss_gmac0_rgmii_set0),
	ipq_mux( 3, pcie_rst_n_toba,				pcie_rst_n_toba),
	...
	ipq_mux(32, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	ipq_mux(33, gsbi6_spi_reset_cfg,		gsbi6_spi_reset_cfg),
	ipq_mux(48, pcie_rst_n_toba,				pcie_rst_n_toba),
	ipq_mux(51, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	ipq_mux(52, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	ipq_mux(53, ipq806x_leds_cfg,			ipq806x_leds_cfg),
	ipq_mux(54, ipq806x_buttons_cfg,		ipq806x_buttons_cfg),
	...
	ipq_mux(61, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	ipq_mux(62, nss_gmac1_rgmii_set,		nss_gmac1_rgmii_set),
	ipq_mux(63, pcie_rst_n_toba,				pcie_rst_n_toba),
	ipq_mux(66, nss_gmac0_rgmii_set1,		nss_gmac0_rgmii_set1),
};
...
void __init ipq806x_init_gpiomux(void)
{
	...
	if (machine_is_ipq806x_db149() || machine_is_ipq806x_db149_2xx()) {
		...
		msm_gpiomux_install(ipq806x_ap148_gpiomux,
			...
			msm_gpiomux_install(ipq806x_ap385_gpiomux,
					ARRAY_SIZE(ipq806x_ap385_gpiomux));
		}
		else if (xml_ap_model == AP_387) {
			msm_gpiomux_install(ipq806x_ap387_gpiomux,
					ARRAY_SIZE(ipq806x_ap387_gpiomux));

		}else if (xml_ap_model == AP_374|| xml_ap_model == AP_375|| xml_ap_model == AP_377|| xml_ap_model == AP_318) {
			msm_gpiomux_install(ipq806x_sierra_gpiomux,
					ARRAY_SIZE(ipq806x_sierra_gpiomux));
		} else {
            msm_gpiomux_install(ipq806x_ap32x_gpiomux,
                    ARRAY_SIZE(ipq806x_ap32x_gpiomux));
        }
#else
		msm_gpiomux_install(ipq806x_ap148_gpiomux,
			ARRAY_SIZE(ipq806x_ap148_gpiomux));
