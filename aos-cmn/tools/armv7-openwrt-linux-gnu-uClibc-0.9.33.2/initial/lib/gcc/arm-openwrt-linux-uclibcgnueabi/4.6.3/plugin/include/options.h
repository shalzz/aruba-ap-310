...
enum opt_code
{
  ...
  OPT_Werror_maybe_reset = 208,              /* -Werror-maybe-reset */
  ...
  OPT_fhonour_copts = 583,                   /* -fhonour-copts */
  OPT_fhosted = 584,                         /* -fhosted */
  /* OPT_fhuge_objects = 585, */             /* -fhuge-objects */
  OPT_fident = 586,                          /* -fident */
  OPT_fif_conversion = 587,                  /* -fif-conversion */
  OPT_fif_conversion2 = 588,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 589,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 590,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 591,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 592,             /* -fimplicit-templates */
  OPT_findirect_classes = 593,               /* -findirect-classes */
  OPT_findirect_dispatch = 594,              /* -findirect-dispatch */
  OPT_findirect_inlining = 595,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 596,         /* -finhibit-size-directive */
  OPT_finit_character_ = 597,                /* -finit-character= */
  OPT_finit_integer_ = 598,                  /* -finit-integer= */
  OPT_finit_local_zero = 599,                /* -finit-local-zero */
  OPT_finit_logical_ = 600,                  /* -finit-logical= */
  OPT_finit_real_ = 601,                     /* -finit-real= */
  OPT_finline = 602,                         /* -finline */
  OPT_finline_functions = 603,               /* -finline-functions */
  OPT_finline_functions_called_once = 604,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 605, */            /* -finline-limit- */
  OPT_finline_limit_ = 606,                  /* -finline-limit= */
  OPT_finline_small_functions = 607,         /* -finline-small-functions */
  OPT_finput_charset_ = 608,                 /* -finput-charset= */
  OPT_finstrument_functions = 609,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 610,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 611,/* -finstrument-functions-exclude-function-list= */
  OPT_fintrinsic_modules_path = 612,         /* -fintrinsic-modules-path */
  OPT_fipa_cp = 613,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 614,                   /* -fipa-cp-clone */
  OPT_fipa_matrix_reorg = 615,               /* -fipa-matrix-reorg */
  OPT_fipa_profile = 616,                    /* -fipa-profile */
  OPT_fipa_pta = 617,                        /* -fipa-pta */
  OPT_fipa_pure_const = 618,                 /* -fipa-pure-const */
  OPT_fipa_reference = 619,                  /* -fipa-reference */
  OPT_fipa_sra = 620,                        /* -fipa-sra */
  OPT_fipa_struct_reorg = 621,               /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 622,                 /* -fira-algorithm= */
  ...
  OPT_floop_strip_mine = 642,                /* -floop-strip-mine */
  OPT_flto = 643,                            /* -flto */
  OPT_flto_compression_level_ = 644,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 645,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 646,         /* -flto-partition=balanced */
  OPT_flto_partition_none = 647,             /* -flto-partition=none */
  OPT_flto_report = 648,                     /* -flto-report */
  OPT_flto_ = 649,                           /* -flto= */
  OPT_fltrans = 650,                         /* -fltrans */
  OPT_fltrans_output_list_ = 651,            /* -fltrans-output-list= */
  OPT_fmain_ = 652,                          /* -fmain= */
  OPT_fmath_errno = 653,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 654,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 655,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 656,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 657,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 658,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 659,                     /* -fmem-report */
  OPT_fmerge_all_constants = 660,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 661,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 662,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 663,                /* -fmessage-length= */
  OPT_fmodule_private = 664,                 /* -fmodule-private */
  OPT_fmodulo_sched = 665,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 666,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 667,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 668,                  /* -fms-extensions */
  OPT_fmudflap = 669,                        /* -fmudflap */
  OPT_fmudflapir = 670,                      /* -fmudflapir */
  OPT_fmudflapth = 671,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 672, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 673, */                  /* -fnew-abi */
  OPT_fnext_runtime = 674,                   /* -fnext-runtime */
  OPT_fnil_receivers = 675,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 676,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 677,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 678, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 679,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 680,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 681,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 682,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 683,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 684,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 685,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 686,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 687,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 688,             /* -fomit-frame-pointer */
  OPT_fopenmp = 689,                         /* -fopenmp */
  OPT_foperator_names = 690,                 /* -foperator-names */
  OPT_foptimize_register_move = 691,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 692,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 693,/* -foptimize-static-class-initialization */
  /* OPT_foptional_diags = 694, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 695,              /* -foutput-class-dir= */
  OPT_fpack_derived = 696,                   /* -fpack-derived */
  OPT_fpack_struct = 697,                    /* -fpack-struct */
  OPT_fpack_struct_ = 698,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 699,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 700,              /* -fpcc-struct-return */
  OPT_fpch_deps = 701,                       /* -fpch-deps */
  OPT_fpch_preprocess = 702,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 703,                     /* -fpeel-loops */
  OPT_fpeephole = 704,                       /* -fpeephole */
  OPT_fpeephole2 = 705,                      /* -fpeephole2 */
  OPT_fpermissive = 706,                     /* -fpermissive */
  OPT_fpic = 707,                            /* -fpic */
  OPT_fpie = 708,                            /* -fpie */
  OPT_fplan9_extensions = 709,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 710,                    /* -fplugin-arg- */
  OPT_fplugin_ = 711,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 712,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 713,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 714,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 715,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 716,                   /* -fpreprocessed */
  OPT_fpretty_templates = 717,               /* -fpretty-templates */
  OPT_fprofile = 718,                        /* -fprofile */
  OPT_fprofile_arcs = 719,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 720,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 721,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 722,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 723,              /* -fprofile-generate= */
  OPT_fprofile_use = 724,                    /* -fprofile-use */
  OPT_fprofile_use_ = 725,                   /* -fprofile-use= */
  OPT_fprofile_values = 726,                 /* -fprofile-values */
  OPT_fprotect_parens = 727,                 /* -fprotect-parens */
  OPT_frandom_seed = 728,                    /* -frandom-seed */
  OPT_frandom_seed_ = 729,                   /* -frandom-seed= */
  OPT_frange_check = 730,                    /* -frange-check */
  OPT_frealloc_lhs = 731,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 732,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 733,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 734,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 735,                /* -frecord-marker=8 */
  OPT_frecursive = 736,                      /* -frecursive */
  OPT_freduced_reflection = 737,             /* -freduced-reflection */
  OPT_freg_struct_return = 738,              /* -freg-struct-return */
  OPT_fregmove = 739,                        /* -fregmove */
  OPT_frename_registers = 740,               /* -frename-registers */
  OPT_freorder_blocks = 741,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 742,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 743,              /* -freorder-functions */
  OPT_frepack_arrays = 744,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 745,           /* -freplace-objc-classes */
  OPT_frepo = 746,                           /* -frepo */
  OPT_frequire_return_statement = 747,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 748,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 749, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 750,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 751,                    /* -fresolution= */
  OPT_frounding_math = 752,                  /* -frounding-math */
  OPT_frtti = 753,                           /* -frtti */
  OPT_fsaw_java_file = 754,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 755,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 756,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 757,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 758,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 759,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 760,                 /* -fsched-pressure */
