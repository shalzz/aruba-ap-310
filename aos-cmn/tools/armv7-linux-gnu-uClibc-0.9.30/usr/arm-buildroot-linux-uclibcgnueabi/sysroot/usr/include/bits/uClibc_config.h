...
#define __KERNEL_HEADERS__ "/var/tmp/tool-chains/buildroot-2012.11-4.7.2-arm/output/toolchain/linux/include"
...
#define __CROSS_COMPILER_PREFIX__ "/var/tmp/tool-chains/buildroot-2012.11-4.7.2-arm/host/usr/bin/arm-buildroot-linux-uclibcgnueabi-"
